...
const TGPLSidebar = () => {
    ...
    const menuItems = [
        { path: '/lao-cai-v2/tro-giup-phap-ly/chuc-nang-nhiem-vu', label: 'Chức năng, nhiệm vụ', icon: ClipboardList },
        { path: '/lao-cai-v2/tro-giup-phap-ly/co-cau-to-chuc', label: 'Cơ cấu tổ chức', icon: Building2 },
        { path: '/lao-cai-v2/tro-giup-phap-ly/to-chuc', label: 'Tổ chức thực hiện TGPL', icon: Scale },
        { path: '/lao-cai-v2/tro-giup-phap-ly/nguoi-thuc-hien', label: 'Người thực hiện TGPL', icon: Users },
        { path: '/lao-cai-v2/tro-giup-phap-ly/danh-ba', label: 'Danh bạ điện tử TGPL', icon: Phone },
        { path: '/lao-cai-v2/tro-giup-phap-ly/tin-tuc', label: 'Tin tức hoạt động TGPL', icon: Newspaper },
        { path: '/lao-cai-v2/tro-giup-phap-ly/chi-dao-dieu-hanh', label: 'Thông tin chỉ đạo, điều hành', icon: Megaphone },
        { path: '/lao-cai-v2/tro-giup-phap-ly/vu-viec-dien-hinh', label: 'Vụ việc điển hình', icon: Briefcase },
    ];
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-3 pb-3 border-b border-blue-800">
                        ...
                        <div>
                            ...
                            <h3 className="font-bold text-lg leading-tight drop-shadow-sm">TRUNG TÂM TRỢ GIÚP PHÁP LÝ NHÀ NƯỚC TỈNH LÀO CAI</h3>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <p className="text-sm text-blue-50 leading-relaxed font-medium">
                                Số 1B Hoàng Liên, phường Nam Cường, tỉnh Lào Cai
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 bg-[#dc2626] rounded-lg p-4 text-center border border-red-500 shadow-inner">
                        ...
                        <p className="text-2xl font-bold tracking-wider text-white drop-shadow-md">0214.3824.163</p>
                    </div>
                </div>
            </div>
