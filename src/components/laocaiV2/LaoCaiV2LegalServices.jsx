...
import { laocaiV2LegalAidBranches, laocaiV2ConnectedPortals } from '../../data/laocaiV2MockData';

const LaoCaiV2LegalServices = () => {
    const [selectedBranch, setSelectedBranch] = useState(laocaiV2LegalAidBranches[0]);
    ...
    const handleFeedbackSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            setFeedbackForm({ name: '', phone: '', district: 'Phường Duyên Hải', content: '' });
        }, 4000);
    };

    return (
        <section id="tro-giup-phap-ly-lao-cai" className="py-14 bg-gradient-to-b from-[#f1f5f9] to-[#e2e8f0] border-t border-gray-200">
            <div className="max-w-[1400px] mx-auto px-4">
                ...
                <div className="text-center max-w-3xl mx-auto space-y-2 mb-10">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">
                        Trợ Giúp Pháp Lý & Hỗ Trợ Doanh Nghiệp Lào Cai
                    </h2>
                    <p className="text-xs sm:text-sm text-gray-600">
                        Đảm bảo mọi người dân và doanh nghiệp trên địa bàn các xã, phường đều được tiếp cận dịch vụ pháp lý miễn phí, bình đẳng và thuận tiện.
                    </p>
                </div>

                {/* 3 Main Service Cards */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    {/* Card 1: Cổng Dịch vụ công tỉnh Integration */}
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <h3 className="text-lg font-bold text-gray-900 mt-1">
                                    Cổng Dịch vụ công tỉnh Lào Cai
                                </h3>
                                <p className="text-xs text-gray-600 mt-2 leading-relaxed">
                                    Kênh giao tiếp trực tuyến giữa người dân và chính quyền các cấp tỉnh Lào Cai. Nộp hồ sơ thủ tục tư pháp, gửi phản ánh, kiến nghị và tra cứu tiến độ xử lý hồ sơ ngay trên điện thoại di động.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200 hover:border-red-400 transition flex flex-col justify-between">
                        ...
                        <div className="pt-4 border-t border-gray-100 mt-6 space-y-2">
                            <div className="text-xs text-gray-500 flex items-center justify-between">
                                ...
                                <strong className="text-red-700">0214.3354.6163</strong>
                            </div>
                            <a 
                                href="#mang-luoi"
                            ...
                            >
                                <span>Tra cứu 4 chi nhánh tại các xã, phường</span>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <span className="text-[11px] font-bold text-emerald-700 uppercase">
                                    Đoàn Luật sư & Sở Tài chính
                                </span>
                                <h3 className="text-lg font-bold text-gray-900 mt-1">
                                    Hỗ Trợ Pháp Lý Doanh Nghiệp
                                </h3>
                                <p className="text-xs text-gray-600 mt-2 leading-relaxed">
                                    Tháo gỡ vướng mắc pháp lý trong thành lập doanh nghiệp, đầu tư dự án, xuất nhập khẩu qua cửa khẩu, thuế và đất đai. Đội ngũ luật sư thuộc Đoàn Luật sư tỉnh Lào Cai sẵn sàng đồng hành cùng doanh nghiệp, hợp tác xã trên địa bàn tỉnh.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/2 space-y-4">
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                    ...
                                    Mạng Lưới Chi Nhánh Trợ Giúp Pháp Lý tỉnh Lào Cai
                                </h3>
                            ...
                            <div className="space-y-2 max-h-[380px] overflow-y-auto pr-1">
                                {laocaiV2LegalAidBranches.map((branch) => (
                                    <div
                                        key={branch.id}
                ...
                {/* Direct Feedback Form for LaoCaiV2 citizens */}
                    ...
                    <div className="max-w-3xl mx-auto space-y-6">
                        <div className="text-center space-y-2">
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold uppercase">
                                Tiếp Nhận Phản Ánh - Kiến Nghị Vướng Mắc Pháp Luật Tại Lào Cai
                            </h3>
                            <p className="text-xs text-blue-100">
                                Ý kiến của bạn sẽ được chuyển trực tiếp đến Ban Tiếp nhận phản ánh - Sở Tư pháp tỉnh Lào Cai để rà soát, giải quyết.
                            </p>
                        </div>
                        ...
                        {feedbackSent ? (
                            ...
                            <form onSubmit={handleFeedbackSubmit} className="space-y-4">
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    ...
                                    <div>
                                        <label className="block text-xs font-semibold text-blue-200 mb-1">Xã / Phường</label>
                                        <select
                                        ...
                                        >
                                            <option>Phường Duyên Hải</option>
                                            <option>Phường Cốc Lếu</option>
                                            <option>Phường Kim Tân</option>
                                            <option>Xã Mường Khương</option>
                                            <option>Phường Bắc Cường</option>
                                            <option>Xã Bảo Yên</option>
                                            <option>Xã Bắc Hà</option>
                                            <option>Phường Cam Đường</option>
                                            <option>Xã Pom Hán</option>
                                            <option>Xã Bảo Thắng</option>
                                            <option>Phường Sa Pa</option>
                                            <option>Xã Bát Xát</option>
                                            <option>Xã Si Ma Cai</option>
                                            <option>Xã Văn Bàn</option>
                                            <option>Xã Y Tý</option>
                                            <option>Các xã, phường khác</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Mô tả cụ thể văn bản QPPL, quy định hoặc quy trình hành chính đang gặp khó khăn, vướng mắc trên địa bàn tỉnh..."
                                        className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-xs text-white placeholder-blue-300 focus:outline-none focus:ring-2 focus:ring-amber-400"
                                    ></textarea>
                                </div>
                                ...
                                <div className="text-center pt-2">
                                    ...
                                    >
                                        <Send size={14} />
                                        <span>Gửi phản ánh tới UBND & Sở Tư pháp Lào Cai</span>
                                    </button>
                                </div>
                            </form>
                        )}
                ...
                {/* Connected LaoCaiV2 Portals footer grid */}
                <div className="mt-12 pt-8 border-t border-gray-300">
                    <div className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-4 text-center">
                        Hệ thống Cổng thông tin điện tử liên kết tỉnh Lào Cai
                    </div>
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        {laocaiV2ConnectedPortals.map((cp, idx) => (
                            <a 
                                key={idx}
...
export default LaoCaiV2LegalServices;
