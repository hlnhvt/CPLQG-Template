...
const MOCK_RECOMMENDATIONS = [
    { id: 1, type: 'vanban', title: 'Nghị định 102/2024/NĐ-CP chi tiết thi hành Luật Đất đai', reason: 'Luật Đất đai', date: '05/03/2026' },
    { id: 2, type: 'tinbai', title: 'Những điểm mới về bồi thường, hỗ trợ tái định cư', reason: 'Luật Đất đai', date: '12/03/2026' },
    { id: 3, type: 'vanban', title: 'Thông tư 15/2025/TT-BXD về cấp giấy phép xây dựng', reason: 'Doanh nghiệp & Đầu tư', date: '20/02/2026' },
    { id: 4, type: 'tinbai', title: 'Người lao động được hưởng quyền lợi gì theo Luật BHXH mới?', reason: 'Lao động & Việc làm', date: '15/03/2026' },
];
            ...
            <div className="container mx-auto px-4 max-w-[1550px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {MOCK_RECOMMENDATIONS.map(item => (
                        <div key={item.id} className="bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-blue-100/50 p-5 hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full">
                            ...
                            <div className="mt-auto flex items-center justify-between text-[12px] font-medium text-gray-400">
                                <span className={`flex items-center gap-1.5 ${item.type === 'vanban' ? 'text-indigo-500' : 'text-emerald-500'}`}>
                                    {item.type === 'vanban' ? <FileText size={14} /> : <LayoutGrid size={14} />}
