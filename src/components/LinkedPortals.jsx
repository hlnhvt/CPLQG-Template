    ...
    return (
        <div className="bg-white py-10 border-t border-gray-200 mt-12">
            <div className="container mx-auto px-4">
                <h2 className="text-xl font-bold text-primary text-center mb-8 uppercase tracking-wide">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-sm text-center">
                    {portals.map((portal, index) => (
                        <a key={index} href="#" className="flex items-center justify-center p-3 border border-gray-100 rounded hover:border-primary hover:text-primary hover:shadow-sm transition">
                            <span className="font-semibold text-gray-700 hover:text-primary line-clamp-2">{portal.name}</span>
                        </a>
                    ))}
                </div>
            </div>
