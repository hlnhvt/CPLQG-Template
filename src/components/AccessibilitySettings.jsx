    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="accessibility-btn flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 hover:bg-white/20 transition-colors text-white text-xs font-medium"
