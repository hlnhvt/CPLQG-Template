...
const LiveSupportChatbox = ({ isOpen, onClose }) => {
        ...
        setMessages([
            {
                id: 1,
                sender: 'agent',
                text: 'Xin chào quý công dân! Tư vấn viên của Cổng Pháp luật tỉnh Lào Cai đang trực tuyến và sẵn sàng hỗ trợ bạn.',
                time: 'Vừa xong'
            }
        ]);
    };
    ...
    const handleSendMessage = (e) => {
        ...
        setTimeout(() => {
            let replyText = "Cảm ơn bạn đã gửi câu hỏi. Chúng tôi đã ghi nhận nội dung và đang đối chiếu quy định pháp luật liên quan (văn bản pháp luật của Trung ương và nghị quyết, quyết định của HĐND, UBND tỉnh Lào Cai). Chuyên viên sẽ phản hồi chi tiết ngay!";
            if (question.toLowerCase().includes('cửa khẩu')) {
                replyText = "Về hoạt động tại Khu kinh tế cửa khẩu Lào Cai: Doanh nghiệp được hưởng ưu đãi đầu tư theo quy định của pháp luật và Nghị quyết 05/2026/NQ-HĐND của tỉnh; thủ tục xuất nhập khẩu, xuất nhập cảnh được thực hiện tại Cửa khẩu quốc tế Lào Cai theo quy chế phối hợp liên ngành. Bạn có thể liên hệ Ban Quản lý Khu kinh tế tỉnh để được hướng dẫn chi tiết.";
