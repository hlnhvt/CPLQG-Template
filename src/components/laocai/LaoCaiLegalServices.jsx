...
import { laocaiLegalAidBranches, laocaiConnectedPortals } from '../../data/laocaiMockData';

const LaoCaiLegalServices = () => {
    const [selectedBranch, setSelectedBranch] = useState(laocaiLegalAidBranches[0]);
    ...
    return (
        <section id="tro-giup-phap-ly-lao-cai" className="py-14 bg-gradient-to-b from-[#f1f5f9] to-[#e2e8f0] border-t border-gray-200">
            <div className="max-w-[1400px] mx-auto px-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-1/2 space-y-4">
                            ...
                            <div className="space-y-2 max-h-[380px] overflow-y-auto pr-1">
                                {laocaiLegalAidBranches.map((branch) => (
                                    <div
                                        key={branch.id}
                ...
                {/* Direct Feedback Form for LaoCai citizens */}
                ...
                {/* Connected LaoCai Portals footer grid */}
                <div className="mt-12 pt-8 border-t border-gray-300">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        {laocaiConnectedPortals.map((cp, idx) => (
                            <a 
                                key={idx}
...
export default LaoCaiLegalServices;
