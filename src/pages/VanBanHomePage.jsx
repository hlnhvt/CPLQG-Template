                            ...
                            <div className="border border-white/40 rounded-xl p-5 bg-white/10 backdrop-blur-sm">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full bg-white text-gray-700 text-[13px] py-2 px-3 rounded outline-none shadow-sm cursor-pointer border-r-[12px] border-transparent">
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full bg-white text-gray-700 text-[13px] py-2 px-3 rounded outline-none shadow-sm cursor-pointer border-r-[12px] border-transparent">
                                            ...
                                            <option>Quốc hội</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium mb-1.5">Ngày ban hành</label>
                                        <div className="relative text-gray-700">
                                            <input type="text" placeholder="dd/mm/yyyy - dd/mm/yyyy" className="w-full bg-white text-[13px] py-2 px-3 pr-8 rounded outline-none shadow-sm" />
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full bg-white text-gray-700 text-[13px] py-2 px-3 rounded outline-none shadow-sm cursor-pointer border-r-[12px] border-transparent">
                                            <option>Chọn tình trạng hiệu lực</option>
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full bg-gray-200/90 text-gray-500 text-[13px] py-2 px-3 rounded outline-none cursor-not-allowed border-r-[12px] border-transparent" disabled>
            ...
            <div className="container mx-auto px-4 py-8 max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 xl:col-span-9 space-y-8">
                        ...
                        {/* Văn bản mới (Table) */}
                        <section>
                            <h2 className="text-[22px] font-bold text-gray-800 mb-4">Văn bản mới</h2>
                    ...
                    <div className="lg:col-span-4 xl:col-span-3">
                        <div className="bg-white border border-gray-200 rounded overflow-hidden lg:mt-[49px]">
                            <div className="bg-[#155e9e] text-white p-3.5 flex items-center gap-2">
                                <Eye size={18} />
