...
const FAQS = [
    {
        ...
        a: "Bạn có thể chia sẻ ý kiến của mình thông qua mục 'Hiến kế xây dựng và thi hành pháp luật' hoặc sử dụng biểu mẫu liên hệ trên trang này. Ý kiến của bạn sẽ được tự động phân loại và gửi đến cơ quan có thẩm quyền xử lý."
    },
    {
