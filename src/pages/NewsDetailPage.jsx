                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center py-3 border-y border-gray-100 mb-6 text-sm text-gray-500 gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-2 bg-gray-50 px-3 py-1 rounded-full border">
                                    <button className="hover:text-[#0f4c81] font-bold text-lg leading-none">-</button>
                                    <span>100%</span>
                                    <button className="hover:text-[#0f4c81] font-bold text-lg leading-none">+</button>
                                </div>
                                <button className="p-1.5 rounded-full border hover:bg-gray-50 text-[#0f4c81]"><Printer size={16} /></button>
                        ...
                        <div className="prose max-w-none text-gray-800 text-base leading-relaxed">
                            ...
                            <h3 className="text-xl font-bold text-[#0f4c81] mt-8 mb-4">Sơ bộ chấm điểm thử nghiệm trong 2 năm</h3>
                            <p className="mb-4">
                            ...
                            <h3 className="text-xl font-bold text-[#0f4c81] mt-8 mb-4">Đẩy mạnh việc ban hành các văn bản quy định chi tiết</h3>
                            <p className="mb-4">
                        ...
                        <div className="mt-8 pt-6 border-t font-semibold text-right text-sm">
                            Theo <span className="text-[#0f4c81]">Báo Pháp luật Việt Nam</span>
                        </div>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                            ...
                            <div className="p-4 space-y-4">
                                {[
                                    ...
                                    <div key={i} className="flex gap-3 items-start cursor-pointer group pb-4 border-b last:border-0 last:pb-0">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-semibold text-gray-800 group-hover:text-[#0f4c81] leading-snug line-clamp-2">{title}</h4>
                                            <span className="text-[10px] text-gray-500 mt-1 block">10:00 12/05/2025</span>
                                        </div>
                                    </div>
                                ))}
                                <div className="pt-2">
                                    <button className="text-[#0f4c81] text-sm font-medium hover:underline">Xem tất cả tin</button>
                                </div>
                            </div>
                        </div>

                        {/* Propaganda Banner */}
                        <div className="rounded-lg overflow-hidden relative cursor-pointer group shadow-sm border border-orange-200">
                        ...
                        <div className="bg-[#0a365c] text-white rounded-lg p-6 text-center space-y-4 shadow-lg relative overflow-hidden">
                            ...
                            <button className="w-full bg-white text-[#0a365c] font-bold py-2 rounded uppercase text-sm hover:bg-yellow-400 transition mb-2">
                                Gửi phản hồi online
                            </button>
