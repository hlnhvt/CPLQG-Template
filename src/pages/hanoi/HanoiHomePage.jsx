        ...
        <div className="bg-[#f8fafc] min-h-screen font-sans flex flex-col selection:bg-blue-600 selection:text-white">
            ...
            <main className="flex-1 pb-16 space-y-4 sm:space-y-5">
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 lg:gap-7 items-stretch">
                        ...
                        <div className="lg:col-span-7 bg-white rounded-2xl p-4 sm:p-5 border border-gray-200/80 shadow-sm flex flex-col justify-between lg:h-[485px]">
                            {/* Header Khối Tin Hoạt Động phong cách Banner Đặc Sắc đồng bộ màu đỏ Thông Báo */}
                            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#6b1111] via-[#fa3333] to-[#5c0d11] p-3 sm:p-3.5 mb-3 text-white shadow-md border-b-2 border-amber-400 shrink-0">
                        ...
                        >
                            ...
                            {/* Header Bảng Thông Báo phong cách Banner Đặc Sắc */}
                            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#6b1111] via-[#fa3333] to-[#5c0d11] p-3 sm:p-3.5 mb-2.5 text-white shadow-md border-b-2 border-amber-400 shrink-0">
                                {/* Họa tiết trang trí phong cách banner */}
                                <div className="absolute inset-0 bg-[radial-gradient(#ffffff22_1.2px,transparent_1.2px)] [background-size:16px_16px] pointer-events-none" />
                                <div className="absolute -right-8 -top-8 w-28 h-28 rounded-full bg-amber-400/25 blur-xl pointer-events-none" />
                                <div className="absolute -left-8 -bottom-8 w-28 h-28 rounded-full bg-red-400/20 blur-xl pointer-events-none" />
                ...
                <section id="thoi-su-tu-phap" className="py-1 hanoi-animate-fade-up" style={{ animationDelay: '0.2s' }}>
                    <div className="container mx-auto px-4 max-w-[1504px]">
                        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 shadow-sm">
                            {/* Header Khối Thời sự Tư pháp phong cách Banner Đặc Sắc */}
                ...
                <section id="chinh-sach-cuoc-song" className="py-1 hanoi-animate-fade-up" style={{ animationDelay: '0.22s' }}>
                    <div className="container mx-auto px-4 max-w-[1504px]">
                        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 shadow-sm">
                            {/* Header Khối Chính sách & Cuộc sống phong cách Banner Đặc Sắc */}
                            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#6b1111] via-[#fa3333] to-[#5c0d11] p-3.5 sm:p-4 mb-4 text-white shadow-md border-b-2 border-amber-400">
                                <div className="absolute inset-0 bg-[radial-gradient(#ffffff22_1.2px,transparent_1.2px)] [background-size:16px_16px] pointer-events-none" />
                                <div className="absolute -right-8 -top-8 w-28 h-28 rounded-full bg-amber-400/25 blur-xl pointer-events-none" />
                                <div className="absolute -left-8 -bottom-8 w-28 h-28 rounded-full bg-red-400/20 blur-xl pointer-events-none" />
                ...
                <section id="pho-bien-giao-duc" className="py-1 hanoi-animate-fade-up" style={{ animationDelay: '0.28s' }}>
                    <div className="container mx-auto px-4 max-w-[1504px]">
                        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 shadow-sm">
                            {/* Header Khối Phổ biến giáo dục pháp luật phong cách Banner Đặc Sắc */}
                            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#6b1111] via-[#fa3333] to-[#5c0d11] p-3.5 sm:p-4 mb-4 text-white shadow-md border-b-2 border-amber-400">
                                <div className="absolute inset-0 bg-[radial-gradient(#ffffff22_1.2px,transparent_1.2px)] [background-size:16px_16px] pointer-events-none" />
                                <div className="absolute -right-8 -top-8 w-28 h-28 rounded-full bg-amber-400/25 blur-xl pointer-events-none" />
                                <div className="absolute -left-8 -bottom-8 w-28 h-28 rounded-full bg-red-400/20 blur-xl pointer-events-none" />
                ...
                >
                    ...
                    <div className="container mx-auto px-4 max-w-[1504px] relative z-10">
                        <div className="bg-gradient-to-b from-[#fffdf6]/90 via-[#fefaf0]/85 to-[#fef6e4]/90 backdrop-blur-xs rounded-2xl p-6 sm:p-8 border-2 border-amber-300/75 shadow-[0_8px_22px_-3px_rgba(180,83,9,0.18)]">
                            {/* Header Khối Đa phương tiện phong cách Banner Đặc Sắc */}
                            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#6b1111] via-[#fa3333] to-[#5c0d11] p-3.5 sm:p-4 mb-5 text-white shadow-md border-b-2 border-amber-400">
                                <div className="absolute inset-0 bg-[radial-gradient(#ffffff22_1.2px,transparent_1.2px)] [background-size:16px_16px] pointer-events-none" />
                                <div className="absolute -right-8 -top-8 w-28 h-28 rounded-full bg-amber-400/25 blur-xl pointer-events-none" />
                                <div className="absolute -left-8 -bottom-8 w-28 h-28 rounded-full bg-red-400/20 blur-xl pointer-events-none" />
                ...
                <section id="tien-ich-so" className="py-6 hanoi-animate-fade-up" style={{ animationDelay: '0.4s' }}>
                    <div className="container mx-auto px-4 max-w-[1504px]">
                        {/* Header Khối Tiện ích số phong cách Banner Đặc Sắc đồng bộ trang chủ */}
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#6b1111] via-[#fa3333] to-[#5c0d11] p-4 mb-6 text-white shadow-md border-b-2 border-amber-400">
                            <div className="absolute inset-0 bg-[radial-gradient(#ffffff22_1.2px,transparent_1.2px)] [background-size:16px_16px] pointer-events-none" />
                            <div className="absolute -right-8 -top-8 w-28 h-28 rounded-full bg-amber-400/25 blur-xl pointer-events-none" />
                            <div className="absolute -left-8 -bottom-8 w-28 h-28 rounded-full bg-red-400/20 blur-xl pointer-events-none" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-gradient-to-br from-[#07244a] via-[#0d3b75] to-[#051730] text-white rounded-2xl p-6 sm:p-7 border-2 border-blue-400/40 shadow-xl shadow-blue-950/30 hover:shadow-2xl hover:shadow-blue-600/30 hover:-translate-y-1.5 hover:border-amber-400 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between">
                                {/* Watermark icon chìm xoay nhẹ khi hover */}
                                <Smartphone className="text-white/5 absolute -bottom-8 -right-8 w-52 h-52 pointer-events-none group-hover:scale-105 group-hover:rotate-6 transition-all duration-500" />
                                <div className="absolute top-0 right-0 w-40 h-40 bg-cyan-400/15 rounded-full blur-3xl pointer-events-none group-hover:bg-amber-400/20 transition-colors duration-300" />
                                ...
                                <div className="space-y-4 relative z-10">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-white/15 backdrop-blur-md border border-white/20 px-3 py-1 rounded-full">
                                    ...
                                    <div>
                                        <div className="text-xs text-amber-300 font-bold uppercase tracking-normal mb-1">
                                ...
                                <div className="pt-6 relative z-10">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-flex items-center justify-center gap-2 w-full bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-400 hover:from-amber-300 hover:to-yellow-300 text-gray-950 font-bold text-xs uppercase py-3.5 px-5 rounded-xl transition-all duration-300 shadow-lg shadow-amber-400/30 hover:scale-[1.02] active:scale-95 group/btn"
                                    >
                            ...
                            <div className="bg-gradient-to-br from-[#540c11] via-[#7a131b] to-[#36060a] text-white rounded-2xl p-6 sm:p-7 border-2 border-red-400/40 shadow-xl shadow-red-950/30 hover:shadow-2xl hover:shadow-red-600/30 hover:-translate-y-1.5 hover:border-amber-400 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between">
                                {/* Watermark icon chìm xoay nhẹ khi hover */}
                                <Scale className="text-white/5 absolute -bottom-8 -right-8 w-52 h-52 pointer-events-none group-hover:scale-105 group-hover:rotate-6 transition-all duration-500" />
                                <div className="absolute top-0 right-0 w-40 h-40 bg-rose-400/15 rounded-full blur-3xl pointer-events-none group-hover:bg-amber-400/20 transition-colors duration-300" />
                                ...
                                <div className="pt-6 relative z-10">
                                    <Link
                                        ...
                                        className="inline-flex items-center justify-center gap-2 w-full bg-white hover:bg-amber-50 text-red-950 font-bold text-xs uppercase py-3.5 px-5 rounded-xl transition-all duration-300 shadow-lg shadow-black/20 hover:scale-[1.02] active:scale-95 group/btn"
                                    >
                            ...
                            <div className="bg-gradient-to-br from-[#081e3a] via-[#10325e] to-[#051326] text-white rounded-2xl p-6 sm:p-7 border-2 border-indigo-400/40 shadow-xl shadow-indigo-950/30 hover:shadow-2xl hover:shadow-indigo-600/30 hover:-translate-y-1.5 hover:border-cyan-400 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between">
                                {/* Watermark icon chìm xoay nhẹ khi hover */}
                                <Building2 className="text-white/5 absolute -bottom-8 -right-8 w-52 h-52 pointer-events-none group-hover:scale-105 group-hover:rotate-6 transition-all duration-500" />
                                <div className="absolute top-0 right-0 w-40 h-40 bg-cyan-400/15 rounded-full blur-3xl pointer-events-none group-hover:bg-cyan-400/20 transition-colors duration-300" />
                                ...
                                <div className="space-y-4 relative z-10">
                                    ...
                                    <div>
                                        <div className="text-xs text-cyan-300 font-bold uppercase tracking-normal mb-1">
                                ...
                                <div className="pt-6 relative z-10">
                                    <Link
                                        ...
                                        className="inline-flex items-center justify-center gap-2 w-full bg-gradient-to-r from-cyan-400 via-sky-300 to-blue-300 hover:from-cyan-300 hover:to-blue-200 text-gray-950 font-bold text-xs uppercase py-3.5 px-5 rounded-xl transition-all duration-300 shadow-lg shadow-cyan-400/30 hover:scale-[1.02] active:scale-95 group/btn"
                                    >
