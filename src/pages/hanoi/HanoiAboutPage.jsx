...
const HanoiAboutPage = () => {
    useEffect(() => {
        document.title = "Giới thiệu - Cổng Pháp luật Thành phố Hà Nội";
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div className="font-sans min-h-screen flex flex-col bg-[#fcfcfb]">
            ...
            {/* About Hero Banner - Đồng bộ màu sắc & phong cách Banner trang chủ Cổng Hà Nội */}
            <div className="relative text-white min-h-[360px] md:min-h-[400px] overflow-hidden flex flex-col items-center justify-center text-center bg-gradient-to-r from-[#4f56ca] via-[#2c1b92] to-[#4f56ca] border-b border-indigo-400/30">
                ...
                <div className="relative z-10 flex flex-col items-center max-w-4xl px-4 py-10">
                    ...
                    <p className="text-sm sm:text-base text-amber-50/95 max-w-2xl leading-relaxed drop-shadow-sm font-normal">
                        Đồng hành cùng chính quyền, người dân và cộng đồng doanh nghiệp Thủ đô bước vào kỷ nguyên số văn minh, hiện đại
                    </p>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                        <div className="lg:col-span-7 space-y-5">
                            ...
                            <h2 className="text-2xl sm:text-3xl font-bold text-[#0f4c81] leading-tight">
                                Nền tảng số hóa pháp lý thống nhất, phục vụ người dân và doanh nghiệp Thủ đô
                            </h2>
                            <p className="text-gray-700 text-sm sm:text-base leading-relaxed text-justify">
                                Cổng Pháp luật Thành phố Hà Nội là kênh thông tin pháp lý chính thống của chính quyền Thủ đô, được vận hành dưới sự chỉ đạo của UBND Thành phố và giao <strong>Sở Tư pháp Hà Nội</strong> trực tiếp chủ trì quản lý kỹ thuật và nội dung, kết nối liên thông trực tiếp với Cổng Pháp luật quốc gia.
                            </p>
                            <p className="text-gray-700 text-sm sm:text-base leading-relaxed text-justify">
                                Cổng là nơi tập hợp đầy đủ, minh bạch toàn bộ hệ thống Nghị quyết của HĐND, Quyết định của UBND Thành phố, các văn bản hướng dẫn thi hành <strong>Luật Thủ đô 2024</strong>, cùng mạng lưới hỗ trợ pháp lý và trợ giúp pháp lý tại 30 quận, huyện, thị xã.
                            </p>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                                <div className="p-4 rounded-xl bg-blue-50 border border-blue-100 text-center">
                                    <div className="text-2xl font-bold text-blue-900 mb-1">30/30</div>
                                    <div className="text-xs text-gray-600 font-medium">Quận, Huyện, Thị xã</div>
                                </div>
                                <div className="p-4 rounded-xl bg-red-50 border border-red-100 text-center">
                                    <div className="text-2xl font-bold text-red-900 mb-1">2.480+</div>
                                    <div className="text-xs text-gray-600 font-medium">Văn bản QPPL Thành phố</div>
                                </div>
                                <div className="p-4 rounded-xl bg-amber-50 border border-amber-200/80 text-center">
                                    ...
                                    <div className="text-xs text-amber-800 font-semibold">Tích hợp ứng dụng iHanoi</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-5">
                            <div className="rounded-2xl overflow-hidden shadow-md border border-gray-100 relative group">
                                <img src="/thumb1.png" alt="Hanoi Office" className="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-500" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent flex flex-col justify-end p-6 text-white">
                                    ...
                                    <div className="font-bold text-lg">Sở Tư pháp Thành phố Hà Nội</div>
                                    <div className="text-xs text-gray-200 mt-1">Số 1B Trần Phú, P. Mộ Lao, Q. Hà Đông, TP. Hà Nội</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <h3 className="text-2xl sm:text-3xl text-[#0f4c81] font-bold leading-tight">
                                Công nghệ số & AI tối ưu hóa tra cứu pháp luật Thủ đô
                            </h3>
                            <p className="text-gray-700 leading-relaxed text-justify text-sm sm:text-base">
                                Tương tự Cổng Pháp luật quốc gia, Cổng Pháp luật TP Hà Nội tích hợp công nghệ AI trợ lý ảo thông minh, giúp người dân và doanh nghiệp tra cứu nhanh các quy định bồi thường giải phóng mặt bằng, cơ chế thử nghiệm Sandbox Luật Thủ Đô, và quy trình xử lý thủ tục hành chính tư pháp.
                            </p>
                        ...
                        <div className="flex-1 flex justify-center items-center py-6 relative">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-6 pointer-events-none">
                                <h4 className="text-[#0f4c81] font-bold text-base md:text-lg mb-1">Trợ lý AI Thủ đô</h4>
                ...
                <section>
                    <div className="text-center max-w-3xl mx-auto mb-10">
                        ...
                        <p className="text-sm text-gray-600">
                            Xây dựng hệ thống pháp luật Thủ đô công khai, minh bạch, dễ tiếp cận và đi vào thực tiễn cuộc sống
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white p-6 rounded-xl border border-gray-200/90 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="text-xs text-gray-600 leading-relaxed">
                                Cập nhật kịp thời, chính xác 100% văn bản quy phạm pháp luật của HĐND và UBND TP Hà Nội, phân loại theo chuyên đề và tình trạng hiệu lực.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200/90 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="text-xs text-gray-600 leading-relaxed">
                                Kết nối Trung tâm TGPL Nhà nước Hà Nội và 8 chi nhánh phụ trách 30 quận/huyện, tư vấn miễn phí cho đối tượng chính sách.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200/90 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="text-xs text-gray-600 leading-relaxed">
                                Tháo gỡ khó khăn về mặt thể chế, chính sách ưu đãi đầu tư, đổi mới sáng tạo theo quy định đột phá của Luật Thủ Đô 2024.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-600 leading-relaxed">
                                    Số 1B Trần Phú, P. Mộ Lao, Q. Hà Đông, TP. Hà Nội
                                </p>
                            </div>
                        </div>
