...
const HanoiContactPage = () => {
    ...
    useEffect(() => {
        document.title = "Liên hệ - Cổng Pháp luật Thành phố Hà Nội";
        window.scrollTo(0, 0);
    }, []);
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            alert("Thông điệp của bạn đã được gửi thành công! Ban Quản trị Cổng Pháp luật TP Hà Nội sẽ phản hồi qua email hoặc số điện thoại trong thời gian sớm nhất.");
            setFormData({
                fullName: '',
                email: '',
                phone: '',
        ...
        <div className="font-sans min-h-screen flex flex-col bg-[#fcfcfb]">
            ...
            <div className="relative text-white py-10 sm:py-12 text-center overflow-hidden bg-gradient-to-r from-[#4f56ca] via-[#2c1b92] to-[#4f56ca] border-b border-indigo-400/30">
                ...
                <div className="container mx-auto px-4 max-w-[1286px] relative z-10">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-tight mb-2 text-white drop-shadow-md">
                        Liên hệ Cổng Pháp luật Thành phố Hà Nội
                    </h1>
                    ...
                    <p className="text-xs sm:text-sm text-amber-50/95 max-w-2xl mx-auto leading-relaxed drop-shadow-sm font-normal">
                        Sẵn sàng lắng nghe, tiếp nhận và giải đáp ý kiến đóng góp của người dân và doanh nghiệp Thủ đô
                    </p>
                </div>
            </div>
            ...
            <main className="flex-grow container mx-auto px-4 py-12 max-w-[1286px]">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    {/* Left Column: Contact info & iHanoi */}
                        ...
                        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/90 shadow-sm space-y-5">
                            ...
                            <div className="space-y-4 text-xs sm:text-sm">
                                <div className="flex items-start gap-3 text-gray-700">
                                    ...
                                    <div>
                                        <div className="font-bold text-gray-900">Sở Tư pháp Thành phố Hà Nội</div>
                                ...
                                <div className="flex items-start gap-3 text-gray-700">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-gray-600">Số 1B Trần Phú, P. Mộ Lao, Q. Hà Đông, TP. Hà Nội</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 text-gray-700">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-gray-600">(024) 3354.6163 - (024) 3354.6155</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 text-gray-700">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-gray-600">sotuphap@hanoi.gov.vn</div>
                                    </div>
                                </div>
                        ...
                        <div className="rounded-2xl p-6 bg-gradient-to-br from-blue-50/90 via-white to-sky-50/70 border border-blue-200/80 shadow-sm flex items-center justify-between gap-4">
                            <div className="space-y-1">
                                <div className="inline-flex items-center gap-1.5 bg-blue-100 text-[#0f4c81] text-[10px] font-bold uppercase px-2 py-0.5 rounded-full">
                                    <Smartphone size={12} />
                                    <span>Công dân Thủ đô số</span>
                                </div>
                                <h3 className="font-bold text-base text-gray-900">Phản ánh nhanh qua iHanoi</h3>
                                <p className="text-xs text-gray-600">Gửi kiến nghị hiện trường và tra cứu pháp luật tiện lợi trên điện thoại di động.</p>
                            </div>
                            <a
...
export default HanoiContactPage;
