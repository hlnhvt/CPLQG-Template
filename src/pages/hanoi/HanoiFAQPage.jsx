                        ...
                        <div className="lg:w-1/4 flex flex-col gap-6 text-gray-800">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-6">
                                ...
                                <div className="space-y-3.5 text-xs sm:text-sm">
                                    ...
                                    <div className="flex justify-between items-center pb-2.5 border-b border-slate-100">
                                        <span className="text-slate-600">Đã giải đáp thấu đáo</span>
                                        <span className="font-bold text-emerald-600 text-base">4,620</span>
                                    </div>
                                    <div className="flex justify-between items-center pb-2.5 border-b border-slate-100">
                                        <span className="text-slate-600">Tỷ lệ hài lòng</span>
                                        <span className="font-bold text-amber-500 text-base">97.8%</span>
                                    </div>
                                    <div className="flex justify-between items-center pb-2.5 border-b border-slate-100">
                                        <span className="text-slate-600">Cơ quan tham gia</span>
                                        <span className="font-bold text-indigo-900 text-base">52</span>
                                    </div>
                                </div>
                            </div>
