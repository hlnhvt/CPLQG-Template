...
Mong sớm nhận được tư vấn. Tôi xin cảm ơn!`,
    ...
    const answerData = {
        expertName: 'Sở Tài nguyên và Môi trường tỉnh X',
        expertRole: 'Cơ quan quản lý nhà nước',
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-white border-b border-blue-100 p-6 flex items-start gap-4">
                                ...
                                <div className="flex-grow">
                                    <div className="flex flex-wrap items-center gap-3">
                                        ...
                                        <span className={`px-2 py-0.5 rounded text-xs font-bold ${answerData.expertType === 'Cơ quan nhà nước' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}>
