...
export default function HoaGiaiCoSo() {
    ...
    const statsData = [
        { id: 1, year: '2022', province: 'Tỉnh Lào Cai', district: 'Thành phố Lào Cai', ward: 'Phường Cốc Lếu', total: 10, prev: 10, new: 1, completed: 10 },
        { id: 2, year: '2022', province: 'Tỉnh Lào Cai', district: 'Huyện Bát Xát', ward: 'Xã Quang Kim', total: 2, prev: 2, new: 2, completed: 2 },
        { id: 3, year: '2021', province: 'Tỉnh Lào Cai', district: 'Thị xã Sa Pa', ward: 'Xã Tả Van', total: 0, prev: 0, new: 0, completed: 0 }
    ];
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 mb-5 flex flex-col lg:flex-row gap-4 lg:items-end">
                    ...
                    <div className="w-full lg:w-48">
                        ...
                        >
                            ...
                            <option>Xã Quang Kim</option>
                            <option>Xã Tả Van</option>
                        </select>
                    </div>
                    <div className="flex items-center gap-2">
