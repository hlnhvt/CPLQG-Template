...
export default function PBGDPLDanTocMienNui() {
    ...
    const newsData = [
        ...
        generateNewsItem(2, 'Bồi dưỡng kỹ năng PBGDPL cho người có uy tín, trưởng thôn tại xã Si Ma Cai', '18/11/2023 09:00', 'Phát huy vai trò của người có uy tín trong cộng đồng để đưa pháp luật đến gần hơn với người dân.', img2),
    ...
    const researchData = [
        ...
        generateNewsItem(2, 'Vai trò của hương ước, quy ước trong việc duy trì trật tự cộng đồng tại các thôn bản vùng cao Lào Cai', '22/10/2023 15:45', 'Đánh giá sự tác động qua lại giữa phong tục, tập quán của đồng bào Mông, Dao, Tày và pháp luật hiện hành.', img1),
    ...
    const modelsData = [
        generateNewsItem(1, 'Câu lạc bộ pháp luật "Không tảo hôn"', '01/10/2023 14:00', 'Mô hình sinh hoạt định kỳ thu hút đông đảo thanh thiếu niên tham gia tại xã Bắc Hà.', img2),
        generateNewsItem(2, 'Tủ sách pháp luật tại nhà văn hóa thôn', '15/09/2023 09:45', 'Không gian văn hóa kết hợp tuyên truyền pháp luật hiệu quả ở xã Mường Khương.', img3),
        generateNewsItem(3, 'Tuyên truyền pháp luật bằng tiếng bản địa trên loa phát thanh', '22/08/2023 16:00', 'Cách làm tiết kiệm nhưng mang lại sức lan tỏa lớn tại các bản vùng cao xã Y Tý, Bát Xát.', img4),
        generateNewsItem(4, 'Tổ hòa giải "Người có uy tín 5 tốt"', '05/08/2023 10:15', 'Phát huy tiếng nói của người có uy tín, trưởng thôn trong hòa giải tranh chấp ở xã Văn Bàn.', img1),
    ];
