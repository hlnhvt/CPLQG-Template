        ...
        <div className="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-gray-100 min-h-[600px] font-sans">
            ...
            <div className="prose max-w-none text-gray-600 leading-relaxed space-y-6">
                <p className="text-lg text-gray-700 font-medium">
                    Hệ thống Phổ biến, Giáo dục Pháp luật (PBGDPL) tỉnh Lào Cai là nền tảng trực tuyến thuộc Cổng Pháp luật tỉnh Lào Cai, được xây dựng nhằm cung cấp thông tin, kiến thức pháp luật một cách nhanh chóng, chính xác và tiện lợi nhất cho mọi tầng lớp nhân dân, đồng bào các dân tộc và cộng đồng doanh nghiệp trên địa bàn tỉnh.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                    <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                        ...
                        <p className="text-sm">Trở thành kênh thông tin pháp luật uy tín của tỉnh Lào Cai, đóng vai trò cầu nối vững chắc giữa chính quyền và nhân dân, góp phần nâng cao ý thức chấp hành pháp luật, xây dựng xã hội thượng tôn pháp luật.</p>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-xl p-6 border border-green-100">
                        ...
                        <p className="text-sm">Phục vụ đa dạng đối tượng từ người dân, cán bộ công chức, viên chức, học sinh, sinh viên cho đến các doanh nghiệp, tổ chức đang hoạt động trên địa bàn tỉnh Lào Cai.</p>
                    </div>
                </div>
                ...
                <ul className="space-y-4 list-none p-0">
                    {[
                        ...
                        'Số hóa và quản lý cơ sở dữ liệu về mạng lưới báo cáo viên, tuyên truyền viên, hòa giải viên cơ sở tại các xã, phường.'
                    ].map((task, idx) => (
                ...
                <div className="mt-12 bg-slate-50 rounded-xl p-6 border border-slate-100 flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-1">Sở Tư pháp tỉnh Lào Cai (Cơ quan thường trực Hội đồng phối hợp PBGDPL tỉnh)</p>
                        <p className="text-sm text-gray-500">Địa chỉ: Số 1B Hoàng Liên, phường Nam Cường, tỉnh Lào Cai</p>
                    </div>
                </div>
            </div>
        </div>
