...
export default function ThongBaoList({ title, items }) {
    ...
    const realMockData = [
        {
            title: 'Thông báo về việc chuyển địa điểm tiếp công dân của Sở Tư pháp tỉnh Lào Cai',
            description: 'Kể từ ngày 15/08/2026, bộ phận tiếp công dân của Sở Tư pháp sẽ được chuyển về Tầng 1, trụ sở Sở Tư pháp, số 1B Hoàng Liên, phường Nam Cường.',
            date: '20/07/2026'
        },
        {
            title: 'Thông báo kết quả lựa chọn tổ chức đấu giá tài sản',
            description: 'Sở Tư pháp tỉnh Lào Cai thông báo kết quả lựa chọn tổ chức đấu giá tài sản thanh lý của cơ quan năm 2026.',
            date: '10/07/2026'
        },
        {
            title: 'Thông báo tuyển dụng công chức Sở Tư pháp tỉnh Lào Cai đợt 2 năm 2026',
            description: 'Sở Tư pháp tỉnh Lào Cai thông báo tuyển dụng 03 công chức vào vị trí chuyên viên quản lý nhà nước về phổ biến, giáo dục pháp luật và hòa giải ở cơ sở.',
            date: '01/07/2026'
        },
        {
            title: 'Thông báo về việc tổ chức lớp bồi dưỡng nghiệp vụ báo cáo viên pháp luật tỉnh',
            description: 'Thực hiện Kế hoạch công tác năm 2026, Sở Tư pháp thông báo chiêu sinh lớp bồi dưỡng nghiệp vụ dành cho báo cáo viên pháp luật tỉnh và tuyên truyền viên pháp luật các xã, phường đợt 1.',
            date: '15/06/2026'
        },
        {
            title: 'Thông báo gia hạn thời gian nộp bài dự thi Cuộc thi trực tuyến Tìm hiểu pháp luật tỉnh Lào Cai',
