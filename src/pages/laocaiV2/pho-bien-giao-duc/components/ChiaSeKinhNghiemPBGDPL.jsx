...
export default function ChiaSeKinhNghiemPBGDPL() {
    ...
    const diaBanDacThuData = [
        ...
        generateNewsItem(2, 'Phổ biến pháp luật cho người lao động tại các khu, điểm du lịch Sa Pa', '18/11/2023 09:00', 'Cách thức tổ chức các buổi sinh hoạt chuyên đề trực tiếp tại cơ sở lưu trú, homestay và điểm du lịch cộng đồng.', img3),
    ...
    const bienGioiData = [
        generateNewsItem(1, 'Tuyên truyền quy chế biên giới cho cư dân hai bên biên giới Việt - Trung', '01/11/2023 10:00', 'Phối hợp với lực lượng bộ đội biên phòng tổ chức các buổi tuyên truyền bằng cả hai ngôn ngữ.', img2),
        generateNewsItem(2, 'Ngăn chặn tình trạng xuất nhập cảnh trái phép tuyến biên giới Lào Cai - Vân Nam', '22/10/2023 15:45', 'Kinh nghiệm của các xã biên giới Bát Xát, Mường Khương, Y Tý trong công tác đấu tranh phòng chống tội phạm.', img1),
