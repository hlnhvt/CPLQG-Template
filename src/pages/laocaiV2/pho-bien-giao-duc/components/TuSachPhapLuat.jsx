...
export default function TuSachPhapLuat() {
    ...
    const data2 = [
        ...
        generateNewsItem(4, 'Sổ tay hướng dẫn công tác báo cáo viên pháp luật', '01/11/2023 08:30', 'Tài liệu dành cho báo cáo viên, tuyên truyền viên pháp luật cấp tỉnh và cấp xã.', validImages[1]),
    ];
