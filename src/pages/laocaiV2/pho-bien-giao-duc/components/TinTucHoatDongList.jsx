        ...
        return [
            {
                ...
                description: 'Tại điểm cầu tỉnh Lào Cai, lãnh đạo UBND tỉnh, Sở Tư pháp và các sở, ngành dự Hội nghị trực tuyến toàn quốc triển khai công tác tư pháp năm 2026 do Bộ Tư pháp tổ chức, tập trung các giải pháp nâng cao hiệu quả công tác phổ biến, giáo dục pháp luật...',
                date: '15/07/2026',
            ...
            {
                id: 2,
                title: 'Lào Cai tổ chức tuyên truyền pháp luật về trật tự an toàn giao thông',
                description: 'Sở Tư pháp tỉnh Lào Cai phối hợp với Công an tỉnh tổ chức các buổi tuyên truyền lưu động về pháp luật an toàn giao thông cho học sinh các trường THPT trên địa bàn tỉnh.',
                date: '10/07/2026',
            ...
            },
            {
                ...
                description: 'Lễ ký kết chương trình phối hợp giữa Sở Tư pháp và Hội Liên hiệp Phụ nữ tỉnh Lào Cai nhằm tăng cường công tác phổ biến, giáo dục pháp luật, tư vấn pháp luật cho phụ nữ, nhất là phụ nữ dân tộc thiểu số.',
                date: '05/07/2026',
                category: 'Hoạt động PBGDPL ở Địa phương',
                image: 'https://images.unsplash.com/photo-1575505586569-646b2ca898fc?auto=format&fit=crop&q=80&w=400&h=300'
            },
            {
                id: 4,
                title: 'Mô hình Cà phê pháp luật phát huy hiệu quả tại phường Lào Cai',
                description: 'Nhiều xã, phường trên địa bàn tỉnh Lào Cai đang triển khai nhân rộng mô hình "Cà phê pháp luật", tạo không gian gần gũi để người dân dễ dàng tiếp cận các quy định pháp luật mới ban hành.',
                date: '02/07/2026',
                category: 'Hoạt động PBGDPL ở Địa phương',
            ...
            },
            {
                ...
                description: 'Hơn 150 báo cáo viên pháp luật tỉnh, tuyên truyền viên các xã, phường đã tham gia lớp tập huấn chuyên sâu về kỹ năng truyền thông các dự thảo chính sách pháp luật có tác động lớn đến đời sống xã hội.',
                date: '28/06/2026',
                category: 'Hoạt động PBGDPL ở Địa phương',
        ...
        <div className="flex flex-col gap-6 font-sans">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-2">
                <div className="flex items-center gap-2 text-sm text-gray-500 mb-4 font-medium">
                    <Link to="/lao-cai-v2/pho-bien-giao-duc" className="text-blue-600 hover:underline">Trang chủ</Link>
                    ...
                    filteredItems.map((item, idx) => (
                        <div key={idx} className="group bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col md:flex-row min-h-[160px]">
                            ...
                            <div className="p-5 flex flex-col flex-1 relative">
                                ...
                                <Link to={`/lao-cai-v2/pho-bien-giao-duc/tin-tuc/${item.id || 1}`} className="text-blue-600 font-semibold text-sm flex items-center gap-1 group/btn mt-auto ml-auto w-fit">
                                    Xem chi tiết 
