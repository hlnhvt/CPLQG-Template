...
export default function GiaoDucPhapLuatNhaTruong({ title }) {
    ...
    const tabs = [
        ...
        { id: 'bai-giang', label: 'Bài giảng điện tử', isExternal: true, path: '/lao-cai-v2/pho-bien-giao-duc?activeMenu=boi-duong-tap-huan' },
        { id: 'hoi-dap', label: 'Hỏi đáp pháp luật học đường', isExternal: true, path: '/lao-cai-v2/hoi-dap' }
    ];

    const realMockData = [
        {
            title: 'Trường THPT số 1 Lào Cai tổ chức ngoại khóa Tìm hiểu pháp luật về giao thông đường bộ',
            description: 'Sáng thứ 2, ngày 15/09, Đoàn trường THPT số 1 Lào Cai đã phối hợp với Công an phường Lào Cai tổ chức buổi ngoại khóa chuyên đề về an toàn giao thông cho hơn 1.200 học sinh.',
            date: '15/09/2026',
        ...
        {
            title: 'Sở GD&ĐT tỉnh Lào Cai tập huấn triển khai bộ tài liệu giáo dục pháp luật mới',
            description: 'Sở GD&ĐT tỉnh Lào Cai vừa tổ chức khóa tập huấn 3 ngày dành cho giáo viên dạy môn Giáo dục công dân các trường THPT về việc tích hợp nội dung pháp luật vào bài giảng.',
            date: '10/09/2026',
            category: 'Hoạt động PBGDPL ở Địa phương',
        ...
        {
            title: 'Mô hình "Phiên tòa giả định" tại các trường phổ thông dân tộc nội trú tỉnh Lào Cai mang lại hiệu quả cao',
            description: 'Việc tổ chức các "Phiên tòa giả định" tại trường học giúp học sinh dân tộc nội trú hiểu rõ hậu quả pháp lý của hành vi vi phạm, nâng cao nhận thức pháp luật một cách trực quan, sinh động.',
            date: '28/08/2026',
            category: 'Hoạt động PBGDPL ở Địa phương',
