                    ...
                    <table className="w-full text-left border-collapse min-w-[700px]">
                        <thead>
                            <tr className="bg-gray-50 text-gray-500 text-[11px] uppercase tracking-wider">
                                ...
                                <th className="px-4 py-3 font-semibold">Địa bàn</th>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex-1">
                        ...
                        <div className="flex justify-between items-center mb-6 px-4">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-blue-600">12 tỷ</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wide mt-1">Tổng kinh phí</div>
                            </div>
                            <div className="text-center hidden sm:block">
                                <div className="text-xl font-bold text-indigo-600">1,2 tỷ</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wide mt-1">Cấp tỉnh</div>
                            </div>
                            <div className="text-center hidden sm:block">
                                <div className="text-xl font-bold text-purple-600">800 triệu</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wide mt-1">Sở, ngành</div>
                            </div>
                            <div className="text-center hidden sm:block">
                                <div className="text-xl font-bold text-blue-800">10 tỷ</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wide mt-1">Cấp xã</div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="text-center">
                                    <div className="text-xl font-bold text-green-500">89,9%</div>
                        ...
                        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex flex-col">
                            ...
                            <div className="flex-1 flex items-center justify-around">
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-teal-600">2.846</div>
                                    <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wide mt-1">Tổ hòa giải</div>
                                </div>
                                <div className="w-px h-10 bg-gray-200"></div>
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-teal-600">15.320</div>
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">Tổng hợp từ các sở, ngành, xã, phường</p>
                        </div>
                    </div>
                    <button className="flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-800 bg-blue-50 px-3 py-1.5 rounded-lg transition-colors">
                        Xem tất cả <ArrowRight size={14} />
