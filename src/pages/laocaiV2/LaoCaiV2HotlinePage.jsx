...
import { laocaiV2HotlineGroups } from '../../data/laocaiV2MockData';

const ALL_KEY = 'tat-ca';
const TABS = [
    { key: ALL_KEY, label: 'Tất cả', items: laocaiV2HotlineGroups.flatMap((g) => g.items.map((i) => ({ ...i, group: g.key }))) },
    ...laocaiV2HotlineGroups.map((g) => ({ ...g, items: g.items.map((i) => ({ ...i, group: g.key })) }))
];
...
export default LaoCaiV2HotlinePage;
