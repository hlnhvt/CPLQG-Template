...
const InfographicDetailPage = () => {
    ...
    useEffect(() => {
        if (!item) navigate('/lao-cai-v2/infographic', { replace: true });
    }, [item, navigate]);
        ...
        <div className="bg-[#f4f7fb] min-h-screen pb-16">
            ...
            <div className="container mx-auto px-4 max-w-[1280px] pt-5">
                ...
                <nav className="flex items-center flex-wrap gap-1 text-[12px] text-gray-500 mb-5">
                    <Link to="/lao-cai-v2" className="hover:text-blue-600">Trang chủ</Link>
                    <ChevronRight size={12} />
                    <Link to="/lao-cai-v2/tin-tuc" className="hover:text-blue-600">Tin tức và truyền thông</Link>
                    <ChevronRight size={12} />
                    <Link to="/lao-cai-v2/infographic" className="hover:text-blue-600">Infographic</Link>
                    <ChevronRight size={12} />
                    <span className="text-gray-800 font-medium line-clamp-1 max-w-[240px]">{item.title}</span>
                </nav>

                {/* Back button */}
                <button onClick={() => navigate('/lao-cai-v2/infographic')}
                            ...
                            <div className="space-y-3">
                                {relatedItems.map((rel) => (
                                    <div key={rel.id}
                                        ...
                                        onClick={() => navigate(`/lao-cai-v2/infographic/${rel.slug}`)}>
