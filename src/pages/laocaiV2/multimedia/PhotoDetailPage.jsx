...
const MOCK_ALBUM = {
    id: 1,
    title: "Kỷ niệm 80 năm Ngày Tổng tuyển cử đầu tiên tại tỉnh Lào Cai",
    category: "ẢNH HOẠT ĐỘNG » SỰ KIỆN - CHÍNH TRỊ",
    date: "06/01/2026 09:00",
    author: "Ban Biên tập Cổng Pháp luật tỉnh Lào Cai",
    description: "Tháng 1/2026, tại Hội trường UBND tỉnh, Thường trực HĐND tỉnh Lào Cai tổ chức Lễ kỷ niệm 80 năm Ngày Tổng tuyển cử đầu tiên bầu Quốc hội Việt Nam (06/01/1946 – 06/01/2026), ôn lại truyền thống và khẳng định vai trò của cơ quan dân cử địa phương trong xây dựng, giám sát thi hành pháp luật.",
    photos: [
        { id: 1, src: "/thumb1.png", caption: "Toàn cảnh Lễ kỷ niệm tại Hội trường UBND tỉnh Lào Cai." },
        { id: 2, src: "/thumb2.png", caption: "Lãnh đạo Thường trực HĐND tỉnh phát biểu tại buổi lễ." },
        { id: 3, src: "/thumb3.png", caption: "Đại biểu HĐND tỉnh các nhiệm kỳ tham dự buổi lễ." },
        { id: 4, src: "/thumb1.png", caption: "Chương trình nghệ thuật chào mừng của các đội văn nghệ dân tộc." },
        { id: 5, src: "/thumb2.png", caption: "Lãnh đạo tỉnh và các đại biểu chụp ảnh lưu niệm." },
        { id: 6, src: "/thumb3.png", caption: "Triển lãm ảnh về hoạt động của HĐND tỉnh Lào Cai qua các thời kỳ." },
        { id: 7, src: "/thumb1.png", caption: "Đại biểu dâng hương tưởng niệm Chủ tịch Hồ Chí Minh." },
        { id: 8, src: "/thumb2.png", caption: "Học sinh tiêu biểu các xã, phường tham dự buổi lễ." },
    ],
};

const RELATED_ALBUMS = [
    { id: 2, title: "Giám đốc Sở Tư pháp tỉnh Lào Cai làm việc với các xã vùng biên giới", date: "10/03/2026", image: "/thumb2.png", count: 18, category: "ẢNH HOẠT ĐỘNG" },
    { id: 3, title: "Lào Cai hưởng ứng Ngày Pháp luật nước CHXHCN Việt Nam năm 2026", date: "09/11/2025", image: "/thumb3.png", count: 32, category: "ẢNH HOẠT ĐỘNG" },
    { id: 4, title: "Hội thảo nâng cao hiệu quả thi hành pháp luật tỉnh Lào Cai", date: "15/02/2026", image: "/thumb1.png", count: 15, category: "ẢNH HOẠT ĐỘNG" },
];
        ...
        <div className="bg-[#f4f7fb] min-h-screen font-sans pb-16">
            <div className="container mx-auto px-4 max-w-[1200px] pt-6">
                ...
                <nav className="flex items-center flex-wrap gap-1 text-[13px] text-gray-500 mb-5">
                    ...
                    <Link to="/lao-cai-v2/anh" className="hover:text-blue-600">Photo</Link>
                    <ChevronRight size={13} />
                    ...
                    <div className="w-full lg:w-80 shrink-0">
                        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <Link to="/lao-cai-v2/anh" className="flex items-center gap-2 w-full px-4 py-2 text-[12px] text-gray-500 hover:text-blue-600 transition-colors justify-center">
                ...
                <div className="mt-10">
                    <div className="flex items-center gap-2 mb-5">
                        <h2 className="text-[15px] font-bold text-gray-700 uppercase tracking-wide">ẢNH &gt; ẢNH HOẠT ĐỘNG</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {/* Featured related */}
                        <Link to={`/lao-cai-v2/anh/${RELATED_ALBUMS[0].id}`} className="group md:col-span-1 block">
                            ...
                            <p className="text-[11px] text-gray-400 mt-1">{RELATED_ALBUMS[0].date} | Cổng Pháp luật tỉnh Lào Cai</p>
                        </Link>
                        {/* 2 smaller related */}
                        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {RELATED_ALBUMS.slice(1).map(album => (
                                <Link key={album.id} to={`/lao-cai-v2/anh/${album.id}`} className="group block">
                                    ...
                                    <p className="text-[11px] text-gray-400 mt-1">{album.date} | Cổng Pháp luật tỉnh Lào Cai</p>
                                </Link>
                            ))}
                        </div>
                    </div>
