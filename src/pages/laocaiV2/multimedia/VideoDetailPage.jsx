...
// Mock video data
const ALL_VIDEOS = [
    { id: 1, title: "Chủ tịch UBND tỉnh Lào Cai chỉ đạo nâng cao chất lượng xây dựng, thẩm định văn bản QPPL", date: "12/03/2026", duration: "05:32", image: "/thumb1.png", src: "" },
    { id: 2, title: "Giám đốc Sở Tư pháp tỉnh Lào Cai trả lời cử tri về công tác hộ tịch, chứng thực", date: "10/03/2026", duration: "08:14", image: "/thumb2.png", src: "" },
    { id: 3, title: "Toàn cảnh Kỳ họp HĐND tỉnh Lào Cai – Phiên khai mạc", date: "21/10/2025", duration: "12:47", image: "/thumb3.png", src: "" },
    { id: 4, title: "Lào Cai hưởng ứng Ngày Pháp luật nước CHXHCN Việt Nam năm 2026", date: "09/11/2025", duration: "06:05", image: "/thumb1.png", src: "" },
    { id: 5, title: "Hội thảo nâng cao hiệu quả thi hành pháp luật trên địa bàn tỉnh Lào Cai", date: "15/02/2026", duration: "45:30", image: "/thumb2.png", src: "" },
    { id: 6, title: "Trợ giúp pháp lý lưu động cho đồng bào dân tộc thiểu số xã Y Tý", date: "18/03/2026", duration: "03:22", image: "/thumb3.png", src: "" },
    { id: 7, title: "Tọa đàm cải cách thủ tục hành chính và chuyển đổi số ngành Tư pháp tỉnh Lào Cai", date: "05/03/2026", duration: "32:15", image: "/thumb1.png", src: "" },
    { id: 8, title: "Hội nghị triển khai Nghị quyết về phát triển kinh tế cửa khẩu Lào Cai", date: "28/02/2026", duration: "27:40", image: "/thumb2.png", src: "" },
    { id: 9, title: "Khai mạc Triển lãm Pháp luật vì cuộc sống tỉnh Lào Cai 2025", date: "10/11/2025", duration: "04:58", image: "/thumb3.png", src: "" },
    { id: 10, title: "Hội nghị điển hình tiên tiến ngành Tư pháp tỉnh Lào Cai", date: "14/12/2025", duration: "18:22", image: "/thumb1.png", src: "" },
    { id: 11, title: "Phổ biến Luật Đất đai 2024 cho người dân các xã vùng cao Lào Cai", date: "20/03/2026", duration: "15:07", image: "/thumb2.png", src: "" },
    { id: 12, title: "Ký kết quy chế phối hợp hỗ trợ pháp lý giữa Sở Tư pháp và Hiệp hội Doanh nghiệp tỉnh", date: "22/03/2026", duration: "07:45", image: "/thumb3.png", src: "" },
    { id: 13, title: "Hội thi Hòa giải viên giỏi tỉnh Lào Cai năm 2026", date: "25/03/2026", duration: "52:18", image: "/thumb1.png", src: "" },
    { id: 14, title: "Họp báo kết quả rà soát văn bản quy phạm pháp luật của tỉnh Lào Cai", date: "26/03/2026", duration: "09:33", image: "/thumb2.png", src: "" },
    { id: 15, title: "Đối thoại pháp lý với doanh nghiệp tại Khu kinh tế cửa khẩu Lào Cai", date: "27/03/2026", duration: "28:11", image: "/thumb3.png", src: "" },
    { id: 16, title: "Tuyên truyền phòng, chống tảo hôn song ngữ Việt – Mông tại Sa Pa", date: "28/03/2026", duration: "14:00", image: "/thumb1.png", src: "" },
];
...
const VideoDetailPage = () => {
    ...
    const goToPrev = () => hasPrev && navigate(`/lao-cai-v2/video/${ALL_VIDEOS[currentIndex - 1].id}`);
    const goToNext = () => hasNext && navigate(`/lao-cai-v2/video/${ALL_VIDEOS[currentIndex + 1].id}`);
        ...
        <div className="bg-[#f4f7fb] min-h-screen font-sans pb-16">
            <div className="container mx-auto px-4 max-w-[1200px] pt-6">
                ...
                <nav className="flex items-center flex-wrap gap-1 text-[13px] text-gray-500 mb-5">
                    ...
                    <Link to="/lao-cai-v2/tin-tuc" className="hover:text-blue-600">Tin tức</Link>
                    <ChevronRight size={13} />
                    <Link to="/lao-cai-v2/video" className="hover:text-blue-600">Multimedia</Link>
                    <ChevronRight size={13} />
                    <Link to="/lao-cai-v2/video" className="hover:text-blue-600">Video</Link>
                    <ChevronRight size={13} />
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-5">
                        {carouselVideos.map(v => (
                            <Link key={v.id} to={`/lao-cai-v2/video/${v.id}`} className="group block"
