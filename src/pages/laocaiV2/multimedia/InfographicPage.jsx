...
export const INFOGRAPHIC_LIST = Array.from({ length: 22 }, (_, i) => ({
    ...
    source: ['Sở Tư pháp tỉnh Lào Cai', 'Bộ Tư pháp', 'UBND tỉnh Lào Cai', 'Sở Tài chính tỉnh Lào Cai', 'Cổng Pháp luật tỉnh Lào Cai'][i % 5],
...
const InfographicPage = () => {
    ...
    const goDetail = (item) => navigate(`/lao-cai-v2/infographic/${item.slug}`);
    const goPage = (p) => { setPage(p); window.scrollTo({ top: 0, behavior: 'smooth' }); };

    return (
        <div className="bg-[#f4f7fb] min-h-screen pb-16">
            <LaoCaiV2PageIntro
                crumbs={[{ label: 'Multimedia', to: '/lao-cai-v2/video' }, { label: 'Infographic' }]}
                title="Infographic"
                subtitle="Thông tin pháp luật được trực quan hóa, ngắn gọn, dễ hiểu dành cho người dân và doanh nghiệp tỉnh Lào Cai"
            />
                ...
                <div className="flex gap-6">
                    ...
                    <aside className="hidden lg:block w-[280px] shrink-0 space-y-4">
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
                            ...
                            <Link to="/lao-cai-v2/infographic"
                        ...
                        <div className="bg-gradient-to-b from-[#0f4c81] to-[#072d54] text-white p-5 rounded-2xl shadow-md text-center relative overflow-hidden flex flex-col items-center">
                            ...
                            <div className="w-full space-y-2.5 z-10 font-sans">
                                <a href="tel:02143824163" className="flex items-center justify-center gap-2 w-full py-2.5 bg-white text-[#0f4c81] font-bold rounded-lg hover:bg-blue-50 transition-colors text-[12px] shadow-sm">
                                    <Phone size={14} fill="currentColor" /> Gọi tổng đài 0214.3824.163
                                </a>
                                <Link to="/lao-cai-v2/lien-he" className="flex items-center justify-center gap-2 w-full py-2.5 border border-white text-white font-bold rounded-lg hover:bg-white/10 transition-colors text-[12px]">
