...
const MOCK_ALBUM = {
    id: 1,
    title: "Hội nghị tổng kết công tác trợ giúp pháp lý tỉnh Lào Cai năm 2025",
    category: "TRỢ GIÚP PHÁP LÝ » ALBUM ẢNH",
    date: "15/01/2026 09:00",
    author: "Trung tâm TGPL tỉnh Lào Cai",
    description: "Ngày 15/01/2026, Sở Tư pháp tỉnh Lào Cai tổ chức Hội nghị tổng kết công tác trợ giúp pháp lý năm 2025 và triển khai phương hướng, nhiệm vụ năm 2026. Hội nghị có sự tham dự của lãnh đạo UBND tỉnh, đại diện các sở, ngành liên quan, các Chi nhánh trợ giúp pháp lý và UBND các xã, phường trên địa bàn tỉnh.",
    photos: [
        { id: 1, src: "https://picsum.photos/seed/a1/800/600", caption: "Toàn cảnh Hội nghị tổng kết công tác trợ giúp pháp lý tỉnh Lào Cai." },
        { id: 2, src: "https://picsum.photos/seed/a2/800/600", caption: "Lãnh đạo UBND tỉnh Lào Cai phát biểu chỉ đạo tại Hội nghị." },
        ...
        { id: 5, src: "https://picsum.photos/seed/a5/800/600", caption: "Đại diện Chi nhánh trợ giúp pháp lý phát biểu tham luận." },
        ...
        { id: 8, src: "https://picsum.photos/seed/a8/800/600", caption: "Lãnh đạo Sở Tư pháp chụp ảnh lưu niệm cùng các đại biểu tham dự." },
    ],
};

const RELATED_ALBUMS = [
    { id: 2, title: "Đoàn kiểm tra liên ngành làm việc tại Chi nhánh TGPL số 4 (xã Bát Xát)", date: "22/02/2026", image: "https://picsum.photos/seed/album2/400/300", count: 15, category: "ALBUM ẢNH" },
    { id: 3, title: "Hoạt động tư vấn pháp luật trực tiếp tại xã vùng cao Y Tý", date: "10/03/2026", image: "https://picsum.photos/seed/album3/400/300", count: 32, category: "ALBUM ẢNH" },
    { id: 4, title: "Lễ ra mắt mô hình Trợ giúp pháp lý thân thiện với trẻ em tại phường Sa Pa", date: "05/04/2026", image: "https://picsum.photos/seed/album4/400/300", count: 18, category: "ALBUM ẢNH" },
];
        ...
        <div className="bg-[#f4f7fb] min-h-screen font-sans pb-16">
            <div className="container mx-auto px-4 max-w-[1200px] pt-6">
                ...
                <nav className="flex items-center flex-wrap gap-1 text-[13px] text-gray-500 mb-5">
                    <Link to="/lao-cai-v2/tro-giup-phap-ly" className="hover:text-blue-600">Trợ giúp pháp lý</Link>
                    <ChevronRight size={13} />
                    <Link to="/lao-cai-v2/tro-giup-phap-ly/album-anh" className="hover:text-blue-600">Album ảnh</Link>
                    <ChevronRight size={13} />
                    ...
                    <div className="w-full lg:w-80 shrink-0">
                        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <Link to="/lao-cai-v2/tro-giup-phap-ly/album-anh" className="flex items-center gap-2 w-full px-4 py-2 text-[12px] text-gray-500 hover:text-blue-600 transition-colors justify-center mt-2">
                ...
                <div className="mt-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {/* Featured related */}
                        <Link to={`/lao-cai-v2/tro-giup-phap-ly/album-anh/${RELATED_ALBUMS[0].id}`} className="group md:col-span-1 block">
                            ...
                            <p className="text-[11px] text-gray-400 mt-1">{RELATED_ALBUMS[0].date} | Trung tâm TGPL tỉnh Lào Cai</p>
                        </Link>
                        {/* 2 smaller related */}
                        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {RELATED_ALBUMS.slice(1).map(album => (
                                <Link key={album.id} to={`/lao-cai-v2/tro-giup-phap-ly/album-anh/${album.id}`} className="group block">
                                    <div className="relative rounded-xl overflow-hidden aspect-[4/3] bg-gray-200 mb-2">
                                    ...
                                    <p className="text-[11px] text-gray-400 mt-1">{album.date} | Trung tâm TGPL tỉnh Lào Cai</p>
                                </Link>
                            ))}
                        </div>
                    </div>
