...
const VideoPhongSuTGPLPage = () => {
    ...
    const featuredVideo = {
        title: 'Trợ giúp pháp lý lưu động tại các xã biên giới tỉnh Lào Cai',
        date: '07/07/2026',
        time: '08:58',
        views: 0,
        dur: '0:02',
    ...
    const videos = [
        { id: 1, title: 'Trung tâm TGPL tỉnh Lào Cai tư vấn pháp luật tại phiên chợ vùng cao Bắc Hà', date: '01/07/2026', time: '16:46', views: 72, dur: '0:02' },
        { id: 2, title: 'Hướng dẫn người dân yêu cầu trợ giúp pháp lý tại UBND xã, phường', date: '01/07/2026', time: '16:42', views: 194, dur: '0:02' },
        { id: 3, title: 'Trợ giúp pháp lý: Điểm tựa công lý', date: '15/09/2023', time: '10:15', views: 1205, dur: '12:45' },
        { id: 4, title: 'Hành trình mang pháp luật đến bản làng Mường Khương', date: '22/08/2023', time: '09:30', views: 856, dur: '25:10' },
    ];

    return (
        <div className="bg-[#f4f7fb] min-h-screen font-sans pb-20">
            {/* HERO SECTION */}
            <div className="bg-gradient-to-r from-[#4f56ca] via-[#2c1b92] to-[#4f56ca] text-white pt-10 pb-40 relative overflow-hidden">
                <LaoCaiV2BannerDecor />
                <div className="container mx-auto px-4 max-w-[1200px] relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-white text-[15px] leading-relaxed border-l-2 border-yellow-400 pl-3 py-0.5 bg-white/10 rounded-r inline-block">
                            Thư viện video phóng sự về trợ giúp pháp lý trên Cổng Pháp luật tỉnh Lào Cai
                        </p>
                    </div>
                </div>
            </div>
