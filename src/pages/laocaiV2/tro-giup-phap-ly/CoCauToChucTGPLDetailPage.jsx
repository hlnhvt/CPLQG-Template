...
import { MOCK_ORG_UNITS, MOCK_ORG_MEMBERS } from '../../../data/laocaiV2MockCoCauToChuc';
...
const CoCauToChucTGPLDetailPage = () => {
    ...
    return (
        <div className="bg-[#f4f7fb] min-h-screen font-sans pb-20">
            ...
            <div className="bg-white border-b border-gray-200 sticky top-0 z-30 shadow-sm">
                <div className="container mx-auto px-4 py-3 max-w-[1200px] flex items-center justify-between">
                    <div className="flex items-center gap-2 text-[13px] text-gray-500">
                        <Link to="/lao-cai-v2/tro-giup-phap-ly/co-cau-to-chuc" className="hover:text-blue-600 transition-colors">Cơ cấu tổ chức</Link>
            ...
            {/* Profile Hero */}
            <div className="bg-gradient-to-r from-[#4f56ca] via-[#2c1b92] to-[#4f56ca] text-white py-12 relative overflow-hidden shadow-md">
                <LaoCaiV2BannerDecor />
