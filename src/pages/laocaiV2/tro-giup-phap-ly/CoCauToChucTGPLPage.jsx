...
import { MOCK_ORG_UNITS } from '../../../data/laocaiV2MockCoCauToChuc';
                ...
                <div className="container mx-auto px-4 max-w-[1200px] relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-blue-50 text-lg leading-relaxed border-l-4 border-yellow-400 pl-4 py-1 font-medium bg-blue-900/20 rounded-r-lg">
                            Hệ thống tổ chức Trợ giúp pháp lý trên địa bàn tỉnh Lào Cai.
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        {visibleRows.map((row) => {
                                            ...
                                            return (
                                                <tr
                                                    key={row.id}
                                                    onClick={() => navigate(`/lao-cai-v2/tro-giup-phap-ly/co-cau-to-chuc/${row.id}`)}
