...
const VuViecDienHinhTGPLPage = () => {
    ...
    const cases = [
        {
            ...
            field: 'Bào chữa',
            organization: 'Chi nhánh TGPL số 4 (Bát Xát)',
            views: 1205,
            date: '26/05/2026',
        ...
        },
        {
            ...
            field: 'Bảo vệ',
            organization: 'Trung tâm TGPL tỉnh Lào Cai',
            views: 3450,
            date: '25/05/2026',
            summary: 'Chưa có mô tả chi tiết cho vụ việc trợ giúp pháp lý này.'
        },
        {
            ...
            field: 'Bảo vệ',
            organization: 'VPLS Đồng Tâm (Lào Cai)',
            views: 2100,
            date: '25/05/2026',
        ...
        },
        {
            ...
            field: 'Bào chữa',
            organization: 'Chi nhánh TGPL số 1 (Cốc Lếu)',
            views: 890,
            date: '25/05/2026',
            summary: 'Chưa có mô tả chi tiết cho vụ việc trợ giúp pháp lý này.'
        },
        {
            id: 5,
            title: 'Bảo vệ thành công quyền thừa kế cho trẻ em mồ côi tại xã Si Ma Cai',
            field: 'Đại diện ngoài tố tụng',
            organization: 'Chi nhánh TGPL số 3 (Bảo Thắng)',
            views: 1205,
            date: '15/10/2023',
            summary: 'Được Trợ giúp viên pháp lý tham gia tố tụng bảo vệ miễn phí, 3 anh em mồ côi cả cha lẫn mẹ tại xã Si Ma Cai đã được Tòa án bảo vệ quyền thừa kế hợp pháp đối với mảnh đất của gia đình bị chú ruột chiếm đoạt từ nhiều năm trước.'
        },
        {
            id: 6,
    ...
    return (
        <div className="bg-[#f4f7fb] min-h-screen pb-20 font-sans">
            {/* Blue Banner */}
            <div className="overflow-hidden relative bg-gradient-to-r from-[#4f56ca] via-[#2c1b92] to-[#4f56ca] text-white pt-10 pb-16">
                <LaoCaiV2BannerDecor />
                <div className="relative z-10 container mx-auto px-4 max-w-[1200px]">
                    ...
                    <div className="flex items-center gap-3 bg-white/10 p-3 rounded backdrop-blur-sm border-l-4 border-yellow-400 max-w-2xl">
                        <p className="text-[13px] md:text-sm font-medium leading-relaxed">Thông tin chi tiết về các vụ việc trợ giúp pháp lý trên Cổng Pháp luật tỉnh Lào Cai</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex-1 lg:w-[70%]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {paginatedCases.map((item) => (
                                <Link to={`/lao-cai-v2/tro-giup-phap-ly/vu-viec-dien-hinh/${item.id}`} key={item.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all flex flex-col cursor-pointer group block">
