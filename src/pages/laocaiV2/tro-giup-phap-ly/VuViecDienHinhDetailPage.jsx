        ...
        <div className="bg-[#f4f7fb] min-h-screen pb-20 font-sans">
            <div className="container mx-auto px-4 max-w-[1200px] pt-8">
                ...
                <div className="flex items-center text-[13px] text-blue-600 gap-2 mb-6 font-medium">
                    ...
                    <Link to="/lao-cai-v2/tro-giup-phap-ly" className="hover:underline">Trợ giúp pháp lý</Link>
                    <ChevronRight size={14} className="text-gray-400" />
                    <Link to="/lao-cai-v2/tro-giup-phap-ly/vu-viec-dien-hinh" className="hover:underline">Vụ việc</Link>
                    <ChevronRight size={14} className="text-gray-400" />
                    ...
                    <div className="flex-1 lg:w-[70%] space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div className="p-5 text-gray-700 text-[14px] leading-relaxed">
                                Ngày 15/02/2026, tại khu vực chợ trung tâm phường Lào Cai, do mâu thuẫn cá nhân trong việc tranh giành vị trí bán hàng, ông Phạm Tùng S đã có hành vi xô xát, la hét và đập phá một số gian hàng xung quanh. Sự việc thu hút đông đảo người dân tụ tập, gây ùn tắc giao thông và ảnh hưởng nghiêm trọng đến an ninh trật tự tại địa phương.
                            </div>
                        </div>
                            ...
                            <div className="p-6 space-y-7">
                                ...
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div className="pt-0.5">
                                        ...
                                        <div className="text-[14px] font-medium text-gray-800 leading-snug">Trung tâm TGPL NN tỉnh Lào Cai</div>
                                    </div>
                                </div>
