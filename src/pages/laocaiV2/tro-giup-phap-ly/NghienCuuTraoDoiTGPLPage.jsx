...
const NghienCuuTraoDoiTGPLPage = () => {
    ...
    const articles = [
        { id: 1, title: 'Nâng cao chất lượng trợ giúp pháp lý cho đồng bào dân tộc thiểu số tại các xã vùng cao tỉnh Lào Cai', author: 'Trung tâm TGPL', date: '24/6/2026', comments: 0 },
        { id: 2, title: 'Một số vướng mắc khi thực hiện trợ giúp pháp lý sau khi sắp xếp đơn vị hành chính cấp xã', author: 'Sở Tư pháp', date: '24/6/2026', comments: 0 },
        { id: 3, title: 'Vai trò của cộng tác viên trợ giúp pháp lý ở thôn, bản vùng biên giới', author: 'Chi nhánh số 4', date: '24/6/2026', comments: 0 },
        { id: 4, title: 'Kinh nghiệm phối hợp giữa cơ quan tiến hành tố tụng và Trung tâm TGPL trong vụ án có người chưa thành niên', author: 'Trợ giúp viên', date: '24/6/2026', comments: 0 },
    ];
