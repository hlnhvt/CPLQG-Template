...
const TinTucHoatDongTGPLPage = () => {
    ...
    const news = [
        { id: 1, title: 'Hành trình mang ánh sáng pháp luật đến với đồng bào dân tộc thiểu số xã Y Tý', date: '08/07/2026', time: '17:23', summary: 'Ghi nhận nỗ lực không mệt mỏi của các trợ giúp viên pháp lý băng rừng lội suối mang kiế...', isHot: true },
        ...
        { id: 6, title: 'Tập huấn kỹ năng tư vấn pháp luật đất đai cho người nghèo tại xã Văn Bàn', date: '08/07/2026', time: '17:23', summary: 'Nâng cao năng lực chuyên môn cho trợ giúp viên giải quyết các vướng mắc sâu rộng về...', isHot: false },
    ];
                ...
                <div className="container mx-auto px-4 max-w-[1200px] relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-white text-[15px] leading-relaxed border-l-2 border-yellow-400 pl-3 py-0.5 bg-white/10 rounded-r inline-block">
                            Thông tin chi tiết về các hoạt động quan đến trợ giúp pháp lý trên Cổng Pháp luật tỉnh Lào Cai
                        </p>
                    </div>
                </div>
            </div>
