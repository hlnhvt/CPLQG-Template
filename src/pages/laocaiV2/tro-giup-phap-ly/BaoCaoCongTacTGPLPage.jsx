...
const BaoCaoCongTacTGPLPage = () => {
    ...
    const [selectedLocation, setSelectedLocation] = useState('Toàn tỉnh');
    ...
    const reports = [
        { 
            id: 1, title: 'Báo cáo tổng kết công tác trợ giúp pháp lý tỉnh Lào Cai năm 2023', date: '2023-12-31', startDate: '2023-01-01', endDate: '2023-12-31', size: '2.5 MB', type: 'Báo cáo Năm', location: 'Toàn tỉnh', reportingUnit: 'Sở Tư pháp tỉnh Lào Cai',
            children: [
                { id: 11, title: 'Báo cáo tổng kết công tác trợ giúp pháp lý của Trung tâm TGPL Nhà nước tỉnh năm 2023', date: '2023-12-31', startDate: '2023-01-01', endDate: '2023-12-31', size: '2.1 MB', type: 'Báo cáo Năm', location: 'Phường Nam Cường', reportingUnit: 'Trung tâm TGPL Nhà nước tỉnh Lào Cai' },
                { id: 12, title: 'Báo cáo tổng kết hoạt động Chi nhánh TGPL số 1 năm 2023', date: '2023-12-31', startDate: '2023-01-01', endDate: '2023-12-31', size: '1.8 MB', type: 'Báo cáo Năm', location: 'Phường Cốc Lếu', reportingUnit: 'Chi nhánh TGPL số 1' },
                { id: 13, title: 'Báo cáo tổng kết hoạt động Chi nhánh TGPL số 2 năm 2023', date: '2023-12-31', startDate: '2023-01-01', endDate: '2023-12-31', size: '2.0 MB', type: 'Báo cáo Năm', location: 'Phường Sa Pa', reportingUnit: 'Chi nhánh TGPL số 2' }
            ]
        },
        { 
            id: 2, title: 'Báo cáo sơ kết công tác trợ giúp pháp lý 6 tháng đầu năm 2023 trên địa bàn tỉnh Lào Cai', date: '2023-07-15', startDate: '2023-01-01', endDate: '2023-06-30', size: '1.2 MB', type: 'Báo cáo 6 tháng', location: 'Toàn tỉnh', reportingUnit: 'Sở Tư pháp tỉnh Lào Cai',
            children: [
                { id: 21, title: 'Báo cáo sơ kết công tác trợ giúp pháp lý 6 tháng đầu năm 2023 tại Chi nhánh TGPL số 3', date: '2023-07-15', startDate: '2023-01-01', endDate: '2023-06-30', size: '0.9 MB', type: 'Báo cáo 6 tháng', location: 'Xã Bảo Thắng', reportingUnit: 'Chi nhánh TGPL số 3' },
            ]
        },
        { 
            id: 3, title: 'Báo cáo kết quả thực hiện Đề án đổi mới công tác trợ giúp pháp lý trên địa bàn tỉnh', date: '2023-06-30', startDate: '2023-01-01', endDate: '2023-06-30', size: '3.8 MB', type: 'Báo cáo Chuyên đề', location: 'Toàn tỉnh', reportingUnit: 'Sở Tư pháp tỉnh Lào Cai',
            children: []
        },
        { 
            id: 4, title: 'Báo cáo chuyên đề: Tăng cường năng lực TGPL cho các xã vùng cao, biên giới', date: '2023-11-12', startDate: '2023-01-01', endDate: '2023-11-12', size: '3.5 MB', type: 'Báo cáo Chuyên đề', location: 'Toàn tỉnh', reportingUnit: 'Trung tâm TGPL Nhà nước tỉnh Lào Cai',
            children: [
                { id: 41, title: 'Báo cáo chuyên đề: Tăng cường năng lực TGPL tại các xã biên giới Bát Xát, Mường Khương', date: '2023-11-10', startDate: '2023-01-01', endDate: '2023-11-10', size: '1.5 MB', type: 'Báo cáo Chuyên đề', location: 'Khác', reportingUnit: 'Các Chi nhánh TGPL' }
            ]
        }
    ];
    ...
    const filterNode = (node) => {
        const matchLocation = selectedLocation === 'Toàn tỉnh' || selectedLocation === '' || node.location === selectedLocation;
    ...
    return (
        <div className="bg-[#f4f7fb] min-h-screen font-sans">
            {/* HERO SECTION */}
            <div className="bg-gradient-to-r from-[#4f56ca] via-[#2c1b92] to-[#4f56ca] text-white pt-16 pb-24 relative overflow-hidden">
                <LaoCaiV2BannerDecor />
