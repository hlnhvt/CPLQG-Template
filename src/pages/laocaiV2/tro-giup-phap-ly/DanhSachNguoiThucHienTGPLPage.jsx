...
const DanhSachNguoiThucHienTGPLPage = () => {
    ...
    // Mock Data
    const mockWorkers = [
        { id: 1, code: 'BC260615135043', name: 'Nguyễn Thị Hồng Nhung', org: 'Trung tâm TGPL Nhà nước tỉnh Lào Cai', role: '-', province: 'Tỉnh Lào Cai', tabCategory: 'Trợ giúp viên pháp lý' },
        { id: 2, code: 'BC260615160728', name: 'Lò Văn Thành', org: 'Chi nhánh TGPL số 4 (Bát Xát)', role: '-', province: 'Tỉnh Lào Cai', tabCategory: 'Trợ giúp viên pháp lý' },
        { id: 3, code: '-', name: 'Giàng Thị Mai', org: 'Chi nhánh TGPL số 2 (Sa Pa)', role: 'Khác', province: 'Tỉnh Lào Cai', tabCategory: 'Trợ giúp viên pháp lý' },
        { id: 4, code: 'LS.12345', name: 'Luật sư Trần Quốc Hưng', org: 'Đoàn Luật sư tỉnh Lào Cai', role: 'Luật sư', province: 'Tỉnh Lào Cai', tabCategory: 'Luật sư thực hiện trợ giúp pháp lý' },
        { id: 5, code: '-', name: 'Sùng A Páo', org: 'UBND xã Si Ma Cai', role: 'Cộng tác viên', province: 'Tỉnh Lào Cai', tabCategory: 'Cộng tác viên trợ giúp pháp lý' },
    ];
                                            ...
                                            filteredWorkers.map((worker, index) => (
                                                <tr key={worker.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td className="py-4 px-4 text-center">
                                                        <Link to={`/lao-cai-v2/tro-giup-phap-ly/nguoi-thuc-hien/${worker.id}`} className="whitespace-nowrap inline-block px-3 py-1.5 border border-gray-300 text-gray-600 rounded text-[13px] hover:bg-gray-50 hover:text-gray-900 transition-colors bg-white font-medium shadow-sm">
                                                            Chi tiết
                                                        </Link>
                                                    </td>
                                                </tr>
