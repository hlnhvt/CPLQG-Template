...
const HuongDanNghiepVuTGPLPage = () => {
    ...
    const guides = [
        { id: 1, title: 'Hướng dẫn kỹ năng tham gia tố tụng vụ án dân sự về tranh chấp đất đai', category: 'NGHIỆP VỤ TRỢ GIÚP PHÁP LÝ TRONG TỐ TỤNG DÂN SỰ', date: '09/07/2026' },
        { id: 2, title: 'Hướng dẫn bào chữa cho người bị buộc tội là người dân tộc thiểu số', category: 'NGHIỆP VỤ TRỢ GIÚP PHÁP LÝ TRONG TỐ TỤNG HÌNH SỰ', date: '29/06/2026' },
        { id: 3, title: 'Kỹ năng tư vấn pháp luật lưu động tại các xã vùng cao', category: 'KỸ NĂNG TƯ VẤN PHÁP LUẬT', date: '29/06/2026' },
        { id: 4, title: 'Kỹ năng đại diện ngoài tố tụng trong giải quyết chế độ chính sách', category: 'KỸ NĂNG ĐẠI DIỆN NGOÀI TỐ TỤNG', date: '29/06/2026' },
        { id: 5, title: 'Hướng dẫn tham gia tố tụng vụ án hành chính về bồi thường, hỗ trợ, tái định cư', category: 'NGHIỆP VỤ TRỢ GIÚP PHÁP LÝ TRONG TỐ TỤNG HÀNH CHÍNH', date: '29/06/2026' },
        { id: 6, title: 'Quy tắc ứng xử của người thực hiện trợ giúp pháp lý tỉnh Lào Cai', category: 'QUY TẮC ỨNG XỬ VÀ ĐẠO ĐỨC NGHỀ NGHIỆP', date: '29/06/2026' },
    ];
