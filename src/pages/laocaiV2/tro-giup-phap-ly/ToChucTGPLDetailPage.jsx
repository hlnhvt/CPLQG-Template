...
const ToChucTGPLDetailPage = () => {
    ...
    const org = {
        name: 'Trung tâm Trợ giúp pháp lý Nhà nước tỉnh Lào Cai',
        code: 'TGPL.LC.001',
        ...
        director: 'Hoàng Văn Thắng',
        memberCount: 18,
        description: 'Trung tâm Trợ giúp pháp lý Nhà nước tỉnh Lào Cai là đơn vị sự nghiệp công lập trực thuộc Sở Tư pháp tỉnh Lào Cai, có chức năng cung cấp dịch vụ pháp lý miễn phí cho người được trợ giúp pháp lý theo quy định của pháp luật trong các vụ việc trợ giúp pháp lý, góp phần bảo đảm quyền con người, quyền công dân trong tiếp cận công lý và bình đẳng trước pháp luật.',
    };
            ...
            <div className="bg-white border-b border-gray-200 py-3">
                <div className="container mx-auto px-4 max-w-[1200px]">
                    <div className="flex items-center text-sm text-gray-500 gap-2">
                        ...
                        <Link to="/lao-cai-v2/tro-giup-phap-ly/to-chuc" className="hover:text-blue-600">Tổ chức thực hiện TGPL</Link>
