...
const AlbumAnhTGPLPage = () => {
    ...
    const albums = [
        { id: 1, title: 'Hội nghị tổng kết công tác trợ giúp pháp lý tỉnh Lào Cai năm 2025', date: '15/01/2026', imageCount: 24, cover: 'https://picsum.photos/seed/album1/400/250' },
        { id: 2, title: 'Đoàn kiểm tra liên ngành làm việc tại Chi nhánh TGPL số 4 (xã Bát Xát)', date: '22/02/2026', imageCount: 15, cover: 'https://picsum.photos/seed/album2/400/250' },
        { id: 3, title: 'Hoạt động tư vấn pháp luật trực tiếp tại xã vùng cao Y Tý', date: '10/03/2026', imageCount: 32, cover: 'https://picsum.photos/seed/album3/400/250' },
        { id: 4, title: 'Lễ ra mắt mô hình Trợ giúp pháp lý thân thiện với trẻ em tại phường Sa Pa', date: '05/04/2026', imageCount: 18, cover: 'https://picsum.photos/seed/album4/400/250' },
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            {albums.map(album => (
                                <Link to={`/lao-cai-v2/tro-giup-phap-ly/album-anh/${album.id}`} key={album.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all group cursor-pointer flex flex-col h-full">
