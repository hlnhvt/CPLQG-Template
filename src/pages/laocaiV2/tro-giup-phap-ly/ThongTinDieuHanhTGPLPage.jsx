...
const ThongTinDieuHanhTGPLPage = () => {
    ...
    const documents = [
        { id: 1, title: 'Hướng dẫn lập dự toán ngân sách cho các hoạt động trợ giúp pháp lý lưu động', date: '9/7/2026', code: 'HD-20/TTTGPL', type: 'Hướng dẫn' },
        { id: 2, title: 'Thông báo lịch làm việc với Đoàn khảo sát của Sở Tư pháp về trợ giúp pháp lý', date: '9/7/2026', code: 'TB-19/TTTGPL', type: 'Thông báo' },
        { id: 3, title: 'Công văn yêu cầu chấn chỉnh kỷ luật, kỷ cương tại phòng tiếp dân', date: '9/7/2026', code: 'CV-18/TTTGPL', type: 'Công văn' },
        { id: 4, title: 'Kế hoạch chuyển đổi số trong công tác trợ giúp pháp lý giai đoạn 2026-2030', date: '9/7/2026', code: 'KH-17/TTTGPL', type: 'Kế hoạch' },
        { id: 5, title: 'Quyết định thành lập Đoàn kiểm tra hoạt động trợ giúp pháp lý tại các Chi nhánh', date: '9/7/2026', code: 'QĐ-16/TTTGPL', type: 'Quyết định' },
        { id: 6, title: 'Hướng dẫn tiêu chí đánh giá chất lượng vụ việc đại diện ngoài tố tụng', date: '9/7/2026', code: 'HD-15/TTTGPL', type: 'Hướng dẫn' },
        { id: 7, title: 'Thông báo về việc thay đổi địa điểm Chi nhánh trợ giúp pháp lý số 2 (Sa Pa)', date: '9/7/2026', code: 'TB-14/TTTGPL', type: 'Thông báo' },
        { id: 8, title: 'Công văn đề nghị rà soát danh sách tổ chức tham gia trợ giúp pháp lý trên địa bàn tỉnh', date: '9/7/2026', code: 'CV-13/TTTGPL', type: 'Công văn' },
    ];
