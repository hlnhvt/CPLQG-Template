...
const DanhSachToChucTGPLPage = () => {
    ...
    const mockOrganizations = [
        { id: 1, code: 'TT.01.66', name: 'Trung tâm Trợ giúp pháp lý Nhà nước tỉnh Lào Cai', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Số 1B Hoàng Liên, phường Nam Cường', phone: '0214.3824.163', status: 'Hoạt động' },
        { id: 2, code: 'TT.01.03', name: 'Chi nhánh TGPL số 1 (Cốc Lếu)', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Số 145 đường Nguyễn Huệ, phường Cốc Lếu', phone: '0214.3825.268', status: 'Hoạt động' },
        { id: 3, code: 'TT.01.127', name: 'Chi nhánh TGPL số 2 (Sa Pa)', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Số 12 đường Điện Biên, phường Sa Pa', phone: '0214.3871.902', status: 'Hoạt động' },
        { id: 4, code: 'TT.01.128', name: 'Chi nhánh TGPL số 3 (Bảo Thắng)', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Số 89 đường Nguyễn Tất Thành, xã Bảo Thắng', phone: '0214.3867.452', status: 'Hoạt động' },
        { id: 5, code: 'TT.01.126', name: 'Chi nhánh TGPL số 4 (Bát Xát)', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Số 23 đường Hùng Vương, xã Bát Xát', phone: '0214.3883.210', status: 'Hoạt động' },
        { id: 6, code: 'TT.01.129', name: 'Điểm tiếp nhận yêu cầu TGPL - UBND xã Văn Bàn', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Tổ dân phố số 3, xã Văn Bàn', phone: '0214.3886.119', status: 'Hoạt động' },
        { id: 7, code: 'TT.01.130', name: 'Điểm tiếp nhận yêu cầu TGPL - UBND xã Bảo Yên', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Tổ dân phố số 5, xã Bảo Yên', phone: '0214.3876.402', status: 'Hoạt động' },
        { id: 8, code: 'TT.01.131', name: 'Điểm tiếp nhận yêu cầu TGPL - UBND xã Si Ma Cai', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Thôn Na Cáng, xã Si Ma Cai', phone: '0214.3796.035', status: 'Hoạt động' },
        { id: 9, code: 'TT.01.132', name: 'Điểm tiếp nhận yêu cầu TGPL - UBND xã Mường Khương', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Khu Chợ, xã Mường Khương', phone: '0214.3881.207', status: 'Hoạt động' },
        { id: 10, code: 'TT.01.134', name: 'Điểm tiếp nhận yêu cầu TGPL - UBND xã Y Tý', tabCategory: 'Trung tâm trợ giúp pháp lý', address: 'Thôn Mò Phú Chải, xã Y Tý', phone: '0214.3885.072', status: 'Hoạt động' },
    ];
                ...
                <div className="container mx-auto px-4 max-w-[1200px] relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-blue-50 text-[15px] leading-relaxed border-l-4 border-yellow-400 pl-4 py-1.5 font-medium bg-blue-900/20 rounded-r-lg max-w-2xl shadow-sm">
                            Tìm kiếm và tra cứu thông tin các Trung tâm Trợ giúp pháp lý Nhà nước, tổ chức hành nghề luật sư và tổ chức tư vấn pháp luật có đăng ký tham gia trợ giúp pháp lý trên địa bàn tỉnh Lào Cai.
                        </p>
                    </div>
                </div>
            </div>
                                        ...
                                        {filteredOrganizations.length > 0 ? (
                                            filteredOrganizations.map((org, index) => (
                                                <tr key={org.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td className="py-4 px-4 text-center">
                                                        <Link to={`/lao-cai-v2/tro-giup-phap-ly/to-chuc/${org.id}`} className="whitespace-nowrap inline-block px-3 py-1.5 border border-gray-300 text-gray-600 rounded text-[13px] hover:bg-gray-50 hover:text-gray-900 transition-colors bg-white font-medium shadow-sm">
                                                            Chi tiết
                                                        </Link>
                                                    </td>
                                                </tr>
