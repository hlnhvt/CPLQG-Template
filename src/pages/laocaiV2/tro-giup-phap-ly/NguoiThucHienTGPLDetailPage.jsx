...
const NguoiThucHienTGPLDetailPage = () => {
    ...
    const worker = {
        ...
        org: 'Trung tâm Trợ giúp pháp lý Nhà nước tỉnh Lào Cai',
        orgId: 1, // To link back to org detail
        province: 'Lào Cai',
        experience: '12 năm',
        education: 'Thạc sĩ Luật học',
        phone: '0988.xxx.xxx',
        email: 'annv.stp@laocai.gov.vn',
        status: 'Đang hoạt động',
        fields: ['Hình sự', 'Dân sự', 'Hành chính'],
        bio: 'Ông Nguyễn Văn An đã có hơn 12 năm kinh nghiệm công tác trong lĩnh vực trợ giúp pháp lý. Từng trực tiếp tham gia bào chữa, bảo vệ thành công quyền và lợi ích hợp pháp cho hàng trăm người yếu thế trong xã hội, đặc biệt là người nghèo, đồng bào dân tộc thiểu số và trẻ em có hoàn cảnh khó khăn tại các xã vùng cao, biên giới của tỉnh Lào Cai.',
        achievements: [
            'Bằng khen của Chủ tịch UBND tỉnh Lào Cai năm 2021',
            ...
            <div className="bg-white border-b border-gray-200 py-3">
                <div className="container mx-auto px-4 max-w-[1000px]">
                    <div className="flex items-center text-sm text-gray-500 gap-2">
                        <Link to="/lao-cai-v2/tro-giup-phap-ly/nguoi-thuc-hien" className="hover:text-blue-600 transition-colors">Người thực hiện TGPL</Link>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-gray-600">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Link to={`/lao-cai-v2/tro-giup-phap-ly/to-chuc/${worker.orgId}`} className="text-gray-700 hover:text-blue-600 font-bold hover:underline transition-colors leading-relaxed">
                                        {worker.org}
                                    </Link>
                                </div>
                            </div>
