...
const VideoTGPLDetailPage = () => {
    ...
    const goToPrev = () => hasPrev && navigate(`/lao-cai-v2/tro-giup-phap-ly/video/${ALL_VIDEOS[currentIndex - 1].id}`);
    const goToNext = () => hasNext && navigate(`/lao-cai-v2/tro-giup-phap-ly/video/${ALL_VIDEOS[currentIndex + 1].id}`);
        ...
        <div className="bg-[#f4f7fb] min-h-screen font-sans pb-16">
            <div className="container mx-auto px-4 max-w-[1200px] pt-6">
                ...
                <nav className="flex items-center flex-wrap gap-1 text-[13px] text-gray-500 mb-5">
                    ...
                    <Link to="/lao-cai-v2/tro-giup-phap-ly/video" className="hover:text-blue-600">Video phóng sự TGPL</Link>
                    <ChevronRight size={13} />
                ...
                <div className="flex items-center gap-3 mt-4 mb-8">
                    <span className="text-[12px] text-gray-500">{video.date} | Trung tâm TGPL tỉnh Lào Cai</span>
                    <div className="flex-1" />
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-5">
                        {carouselVideos.map(v => (
                            <Link key={v.id} to={`/lao-cai-v2/tro-giup-phap-ly/video/${v.id}`} className="group block"
