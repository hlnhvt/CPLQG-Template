...
export const diaPhuongData = Array.from({ length: 5 }).map((_, idx) => {
    const provinces = ['Phường Cam Đường', 'Phường Lào Cai', 'Phường Sa Pa', 'Xã Bát Xát', 'Xã Bảo Thắng'];
    return {
        id: 1601 + idx, isNews: true,
        title: `Chương trình hỗ trợ pháp lý doanh nghiệp trên địa bàn ${provinces[idx % 5]} năm 2026`,
        summary: "UBND xã, phường ban hành kế hoạch chi tiết nhằm tháo gỡ vướng mắc, cải thiện môi trường đầu tư và nâng cao năng lực cạnh tranh cho doanh nghiệp địa phương.",
        ...
        content: `<h4>1. Đặc thù địa phương</h4><p>${provinces[idx % 5]} tập trung cải thiện môi trường kinh doanh, góp phần nâng cao chỉ số PCI của tỉnh Lào Cai để tháo gỡ khó khăn về thủ tục hành chính, đất đai và vốn vay cho doanh nghiệp.</p>`
    };
});
...
export const chuongTrinhData = Array.from({ length: 4 }).map((_, idx) => ({
    ...
    summary: "Chương trình được triển khai nhằm cung cấp dịch vụ hỗ trợ pháp lý chất lượng cao, miễn phí cho doanh nghiệp trên địa bàn tỉnh Lào Cai.",
...
export const advisorsData = [
    {
        ...
        field: "Tất cả",
        org: "Đoàn Luật sư tỉnh Lào Cai",
        exp: "15 năm",
        phone: "0904.123.456",
        email: "nguyenminh@lawfirm.vn",
        province: "Phường Nam Cường",
        diaChiLamViec: "Số 36 đường Hoàng Liên, phường Nam Cường, tỉnh Lào Cai",
        ...
        kinhNghiem: "• Luật sư thành viên Đoàn Luật sư tỉnh Lào Cai (2009 - nay)\n• Tư vấn chính cho 50+ dự án FDI tổng vốn 500 triệu USD",
        ...
        experience: "• Luật sư thành viên Đoàn Luật sư tỉnh Lào Cai (2009 - nay)\n• Tư vấn chính cho 50+ dự án FDI",
        rating: 4.8,
        reviews: []
    },
    {
        ...
        province: "Phường Nam Cường",
        diaChiLamViec: "Số 118 đường Hoàng Liên, phường Nam Cường, tỉnh Lào Cai",
...
export const orgData = [
    {
        ...
        address: "Tầng 3, số 118 đường Hoàng Liên, phường Nam Cường, tỉnh Lào Cai",
        phone: "0214.3827.123",
        ...
        chungChiBangCap: "Giấy phép thành lập số 0123456789 do Sở KH&ĐT tỉnh Lào Cai cấp ngày 15/06/2010.",
...
export const contactData = {
    title: "LIÊN HỆ TRUNG TÂM HỖ TRỢ PHÁP LÝ DOANH NGHIỆP NHỎ VÀ VỪA TỈNH LÀO CAI",
    date: "13/04/2026",
    address: "Số 1B Hoàng Liên, phường Nam Cường, tỉnh Lào Cai",
    phone: "0214.3824.163",
    director: "Lương Văn Hải",
...
export const orgChartData = {
    title: "CƠ CẤU TỔ CHỨC TRUNG TÂM HỖ TRỢ PHÁP LÝ CHO DOANH NGHIỆP NHỎ VÀ VỪA TỈNH LÀO CAI",
    date: "13/04/2026",
    attachments: [
...
export const lienNganhData = {
    ...
    intro: "Chương trình HTPL liên ngành là hoạt động phối hợp giữa Trung tâm HTPLDN tỉnh Lào Cai với các sở, ngành và UBND các xã, phường nhằm cung cấp dịch vụ pháp lý toàn diện, miễn phí cho doanh nghiệp vừa và nhỏ.",
    programs: [
        {
            icon: "🏢",
...
export const functionDutyData = {
    ...
    date: "10/01/2026",
    attachments: [
        { name: "QD_chuc_nang_nhiem_vu_So_Tu_phap_Lao_Cai.pdf", url: "#" }
    ],
    content: {
        intro: "Quyết định của Ủy ban nhân dân tỉnh Lào Cai quy định vị trí, chức năng, nhiệm vụ, quyền hạn và cơ cấu tổ chức của Sở Tư pháp tỉnh Lào Cai như sau:",
        sections: [
            {
                heading: "Vị trí và chức năng",
                text: "Sở Tư pháp là cơ quan chuyên môn thuộc Ủy ban nhân dân tỉnh Lào Cai, tham mưu, giúp Ủy ban nhân dân tỉnh quản lý nhà nước về công tác tư pháp, trong đó có hỗ trợ pháp lý cho doanh nghiệp trên địa bàn tỉnh..."
            }
        ]
    }
};
...
export const tongQuanData = [
    { id: 1201, title: "Tổng quan chương trình hỗ trợ pháp lý doanh nghiệp nhỏ và vừa giai đoạn 2026-2030", summary: "Tóm tắt mục tiêu, nhiệm vụ trọng tâm và lộ trình thực hiện chương trình hỗ trợ pháp lý trên địa bàn tỉnh Lào Cai.", date: "15/04/2026", thumb: "https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=400", field: "Chính sách", content: "<h4>Chương trình hỗ trợ pháp lý 2026-2030</h4><p>Lộ trình hướng tới cung cấp dịch vụ pháp lý số tích hợp trí tuệ nhân tạo.</p>" }
];
