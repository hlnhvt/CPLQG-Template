...
const KinhNghiemQuocTeTGPLPage = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    const articles = [
        { 
            ...
            date: '11/06/2026', 
            time: '07:39',
            image: 'https://picsum.photos/seed/kn1/400/250' 
        },
        { 
            id: 2, 
            ...
            date: '11/06/2026', 
            time: '08:15',
            image: 'https://picsum.photos/seed/kn2/400/250' 
        },
        { 
            id: 3, 
            ...
            date: '18/05/2026', 
            time: '14:20',
            image: 'https://picsum.photos/seed/kn3/400/250' 
        },
        { 
            id: 4, 
            ...
            date: '18/05/2026', 
            time: '09:05',
            image: 'https://picsum.photos/seed/kn4/400/250' 
        },
    ];
                ...
                <div className="container mx-auto px-4 max-w-[1200px] relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-white text-[15px] leading-relaxed border-l-2 border-yellow-400 pl-3 py-0.5 bg-white/10 rounded-r inline-block">
                            Tìm hiểu và chia sẻ kinh nghiệm từ các quốc gia trên thế giới về công tác trợ giúp pháp lý
                        </p>
                    </div>
                </div>
            </div>
...
export default KinhNghiemQuocTeTGPLPage;
