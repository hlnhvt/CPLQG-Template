...
const PhoBienGiaoDucPhapLuatPage = () => {
    ...
    return (
        <div className="bg-[#f0f4f8] min-h-screen pb-16 font-sans">
            ...
            {/* Main Content Area */}
            <div className="max-w-6xl mx-auto px-4 -mt-14 relative z-20 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-500">Kết quả xây dựng xã, phường đạt chuẩn</p>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="text-center">
                                        <div className="text-xl font-bold text-blue-800">1.012</div>
                                        <div className="text-[9px] font-bold text-gray-500 uppercase tracking-wide mt-0.5">Xã đang phấn đấu</div>
                                    </div>
                                    <div className="text-center">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="text-[9px] font-bold text-gray-500 uppercase tracking-wide mt-0.5">Năm đích</div>
                                    </div>
                                </div>
                            </div>
