...
export default function HoaGiaiCoSoList({ category, onBack }) {
    ...
    const generateNewsItem = (id) => ({
        id,
        title: `${category} - Vụ việc số ${id}`,
        date: `0${(id % 9) + 1}/07/2026`,
        excerpt: `Mô tả chi tiết về vụ việc hòa giải số ${id}. Nêu rõ nguyên nhân, quá trình tiếp nhận và các biện pháp, lý lẽ thấu tình đạt lý được các hòa giải viên áp dụng để hàn gắn mâu thuẫn, mang lại sự đồng thuận cho các bên liên quan.`,
