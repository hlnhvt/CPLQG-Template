...
const GenericFilterSidebar = ({ activeMenu }) => {
    const categories = activeMenu === 'tin-tuc-hoat-dong'
        ? ['Tất cả', 'Hoạt động PBGDPL ở Trung ương', 'Hoạt động PBGDPL ở Địa phương']
        : ['Tất cả', 'Phổ biến giáo dục', 'Hỗ trợ pháp lý'];
