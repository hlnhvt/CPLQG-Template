...
export default function PBGDPLDanTocMienNuiList({ category, onBack }) {
    // Generate some mock data for the list
    const images = [
    ...
    const generateNewsItem = (id) => ({
        id,
        title: `${category} - Bài viết chi tiết số ${id} với nội dung pháp luật quan trọng cần lưu ý`,
        date: `0${(id % 9) + 1}/07/2026`,
        excerpt: `Đoạn trích dẫn ngắn cho bài viết số ${id}. Nội dung này sẽ mô tả tóm tắt những ý chính của bài báo, giúp người đọc nắm bắt thông tin nhanh chóng trước khi quyết định xem chi tiết. Các chính sách pháp luật mới nhất được cập nhật và phân tích chuyên sâu.`,
        ...
        <div className="flex flex-col gap-6 font-sans">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex items-center justify-between mt-2">
                ...
                <div className="flex gap-1">
                    <button className="w-8 h-8 flex items-center justify-center rounded border border-gray-200 text-gray-400 hover:bg-gray-50 text-sm font-medium">
                        «
                    </button>
                    <button className="w-8 h-8 flex items-center justify-center rounded border border-gray-200 text-gray-400 hover:bg-gray-50 text-sm font-medium">
                        ‹
                    ...
                    <button className="w-8 h-8 flex items-center justify-center rounded border border-gray-200 text-gray-600 hover:bg-gray-50 text-sm font-medium">
                        ›
                    </button>
                    <button className="w-8 h-8 flex items-center justify-center rounded border border-gray-200 text-gray-600 hover:bg-gray-50 text-sm font-medium">
                        »
