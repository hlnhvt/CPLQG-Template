                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                                        ...
                                        <ul className="list-none pl-0 space-y-2">
                                            ...
                                            <li className="relative pl-5 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-1.5 before:h-1.5 before:bg-blue-500 before:rounded-full text-justify">Lấy người dân, doanh nghiệp làm trung tâm, chủ thể trong xây dựng, hoàn thiện hệ thống pháp luật. Thúc đẩy văn hóa, trách nhiệm xã hội của doanh nghiệp, người dân trong xây dựng, hoàn thiện hệ thống pháp luật và nâng cao hiệu quả tổ chức thi hành pháp luật góp phần phát triển kinh tế - xã hội của đất nước.</li>
