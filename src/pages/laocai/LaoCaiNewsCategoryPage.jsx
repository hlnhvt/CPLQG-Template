                ...
                <div className="flex items-center h-11">
                    ...
                    <div ref={scrollRef} onScroll={handleScroll}
                        ...
                        {LAOCAI_NEWS_CATEGORIES.map((cat) => {
                            ...
                            return (
                                <Link key={cat.id} to={`/lao-cai/tin-tuc/${cat.id}`}
        ...
        <div className="font-sans min-h-screen flex flex-col bg-[#f4f7fb]">
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="container mx-auto px-4 max-w-[1286px] py-3 text-xs sm:text-sm text-gray-500 flex items-center gap-2">
                    ...
                    <Link to="/lao-cai/tin-tuc" className="hover:text-[#2c1b92] transition-colors">Tin tức &amp; Sự kiện</Link>
                    <ChevronRight size={14} />
            ...
            {/* Sub Nav */}
            <LaoCaiNewsSubNav activeId={category.id} />
                        ...
                        <aside className="w-full lg:w-72 xl:w-80 shrink-0 space-y-6">
                            ...
                            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                                ...
                                <div className="p-3.5 border-t border-gray-100 bg-gray-50/50">
                                    <Link to="/lao-cai/tin-tuc" className="text-[13px] text-[#2c1b92] font-bold hover:text-[#4f56ca] flex items-center gap-1.5 w-fit mx-auto">
...
export default LaoCaiNewsCategoryPage;
