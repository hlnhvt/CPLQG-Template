                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 order-2 lg:order-1 min-w-0">
                        ...
                        {activeTab === 'ban-chi-dao' && (
                            <div className="bg-white rounded-2xl px-4 md:px-8 pt-3 pb-8 shadow-sm border border-gray-100 mt-2 animate-fadeIn">
                                    ...
                                    <div className="animate-fadeIn">
                                        <div className="py-2">
                                            <div className="w-full">
                                                <img
                                                    src="/TintucTongRaSoatDemo/so-do-tong-ra-soat.svg"
                                                    alt="Sơ đồ Ban Chỉ đạo"
                        ...
                        {activeTab === 'tin-tuc-hoat-dong' && (() => {
                            const renderNewsLayout = (newsItems) => {
                                ...
                                const isLessthanFour = newsItems.length < 4;
                                const gridNews = isLessthanFour ? [] : newsItems.slice(1, 4);
                                const listNews = isLessthanFour ? newsItems.slice(1) : newsItems.slice(4);
                            ...
                            <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-gray-100 animate-fadeIn mt-2">
                                <div className="border-b border-gray-200 pb-6 mb-8 bg-white">
                                    <div className="md:px-2 pt-2 text-gray-800 leading-relaxed text-[15px] space-y-4">
                                        ...
                                        <p className="text-base text-justify">
                                            Trí tuệ nhân tạo có khả năng tự động hóa quy trình phân tích văn bản, bước đầu giúp nhận diện, phát hiện quy định chồng chéo, mâu thuẫn, không còn phù hợp với thực tiễn hoặc cản trở sự phát triển kinh tế - xã hội và đề xuất phương án xử lý.
                                        </p>
                                        <p className="text-base text-justify">
                                            Tuy nhiên, việc sử dụng trí tuệ nhân tạo trong rà soát văn bản quy phạm pháp luật chỉ mang tính chất tham khảo, các công cụ trí tuệ nhân tạo chỉ có vai trò hỗ trợ trong nghiệp vụ rà soát. Các cơ quan thực hiện tổng rà soát hệ thống văn bản quy phạm pháp luật phải đặc biệt lưu ý xem xét, đánh giá kỹ lưỡng, khách quan kết quả rà soát văn bản do trí tuệ nhân tạo thực hiện và chịu trách nhiệm về tính chính xác, đầy đủ, toàn diện đối với kết quả tổng rà soát văn bản của cơ quan mình.
                                            Dưới đây là một số công cụ, giải pháp ứng dụng trí tuệ nhân tạo để các cơ quan tham khảo, sử dụng khi thực hiện tổng rà soát hệ thống văn bản quy phạm pháp luật (theo giới thiệu của Bộ Khoa học và Công nghệ tại Công văn số 2766/BKHCN-TTCNTT ngày 29/4/2026):
                                        </p>
                                    </div>
                                </div>
